...
inline std::optional<Instruction> decode_format(uint32_t insn, bool aliases = false) {
    ...
    case 30: // op0=1, op1=1110
        return format::ldst::decode_ldst(insn, aliases);
