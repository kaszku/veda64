// Auto-generated ASL IR types for instruction lifting
...
inline ExprPtr bin_op(const std::string& op, ExprPtr left, ExprPtr right) {
...
inline ExprPtr unary_op(const std::string& op, ExprPtr operand) {
