...
<xsl:template match="/instructionsection">
    ...
    <xsl:if test="/instructionsection/aliasto and (/instructionsection/operationalnotes) and not(/instructionsection/ps_section)">
      <!-- on an alias page, the pseudocode is on the machine instruction -->
      <div class="alias_ps_section">
        <h3 class="pseudocode">Operational Information</h3>
        <p><xsl:text>The description of </xsl:text>
          <xsl:apply-templates select="/instructionsection/aliasto"/>
          <xsl:text> gives the operational information for this instruction.</xsl:text></p>
      </div>
    </xsl:if>
    <!-- otherwise it's not an alias page, or we have the Pseudocode informaton -->
    ...
    <xsl:if test="/instructionsection/operationalnotes/operationalnote">
 ...
 -->
  ...
  <xsl:template match="/instructionsection/ps_section">
    <xsl:if test="@howmany > 1">
      <h2 class="pseudocode">Pseudocode</h2>
    </xsl:if>
    <xsl:apply-templates />
  </xsl:template>
