...
void test_apas_sys_cr_systeminstrs() {
    ...
    if (!result.has_value()) { std::cerr << "DECODE FAIL: apas_sys_cr_systeminstrs" << std::endl; return; }
...
void test_at_sys_cr_systeminstrs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: at_sys_cr_systeminstrs" << std::endl; return; }
...
void test_autia1716_hi_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: autia1716_hi_hints" << std::endl; return; }
...
void test_autiasp_hi_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: autiasp_hi_hints" << std::endl; return; }
...
void test_autiaz_hi_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: autiaz_hi_hints" << std::endl; return; }
...
void test_autib1716_hi_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: autib1716_hi_hints" << std::endl; return; }
...
void test_autibsp_hi_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: autibsp_hi_hints" << std::endl; return; }
...
void test_autibz_hi_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: autibz_hi_hints" << std::endl; return; }
...
void test_axflag_m_pstate() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: axflag_m_pstate" << std::endl; return; }
...
void test_b_only_condbranch() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: b_only_condbranch" << std::endl; return; }
...
void test_b_only_branch_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: b_only_branch_imm" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::B);
...
void test_bc_only_condbranch() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bc_only_condbranch" << std::endl; return; }
...
void test_bl_only_branch_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bl_only_branch_imm" << std::endl; return; }
...
void test_blr_64_branch_reg() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: blr_64_branch_reg" << std::endl; return; }
...
void test_blraa_64p_branch_reg() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: blraa_64p_branch_reg" << std::endl; return; }
...
void test_blraaz_64_branch_reg() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: blraaz_64_branch_reg" << std::endl; return; }
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::Register);
...
void test_blrab_64p_branch_reg() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: blrab_64p_branch_reg" << std::endl; return; }
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_blrabz_64_branch_reg() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: blrabz_64_branch_reg" << std::endl; return; }
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::Register);
...
void test_br_64_branch_reg() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: br_64_branch_reg" << std::endl; return; }
...
void test_braa_64p_branch_reg() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: braa_64p_branch_reg" << std::endl; return; }
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_braaz_64_branch_reg() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: braaz_64_branch_reg" << std::endl; return; }
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::Register);
...
void test_brab_64p_branch_reg() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: brab_64p_branch_reg" << std::endl; return; }
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_brabz_64_branch_reg() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: brabz_64_branch_reg" << std::endl; return; }
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::Register);
...
void test_brb_sys_cr_systeminstrs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: brb_sys_cr_systeminstrs" << std::endl; return; }
...
void test_brk_ex_exception() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: brk_ex_exception" << std::endl; return; }
...
void test_bti_hb_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bti_hb_hints" << std::endl; return; }
...
void test_cbbgt_8_regs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbbgt_8_regs" << std::endl; return; }
...
void test_cbbge_8_regs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbbge_8_regs" << std::endl; return; }
...
void test_cbbhi_8_regs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbbhi_8_regs" << std::endl; return; }
...
void test_cbbhs_8_regs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbbhs_8_regs" << std::endl; return; }
...
void test_cbbeq_8_regs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbbeq_8_regs" << std::endl; return; }
...
void test_cbbne_8_regs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbbne_8_regs" << std::endl; return; }
...
void test_cbble_cbbge_8_regs() {
    uint32_t insn = 0x74208000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbble_cbbge_8_regs" << std::endl; return; }
...
void test_cbblo_cbbhi_8_regs() {
    uint32_t insn = 0x74408000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbblo_cbbhi_8_regs" << std::endl; return; }
...
void test_cbbls_cbbhs_8_regs() {
    uint32_t insn = 0x74608000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbbls_cbbhs_8_regs" << std::endl; return; }
...
void test_cbblt_cbbgt_8_regs() {
    uint32_t insn = 0x74008000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbblt_cbbgt_8_regs" << std::endl; return; }
...
void test_cbgt_32_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbgt_32_imm" << std::endl; return; }
...
void test_cblt_32_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cblt_32_imm" << std::endl; return; }
...
void test_cbhi_32_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbhi_32_imm" << std::endl; return; }
...
void test_cblo_32_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cblo_32_imm" << std::endl; return; }
...
void test_cbeq_32_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbeq_32_imm" << std::endl; return; }
...
void test_cbne_32_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbne_32_imm" << std::endl; return; }
...
void test_cbgt_64_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbgt_64_imm" << std::endl; return; }
...
void test_cblt_64_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cblt_64_imm" << std::endl; return; }
...
void test_cbhi_64_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbhi_64_imm" << std::endl; return; }
...
void test_cblo_64_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cblo_64_imm" << std::endl; return; }
...
void test_cbeq_64_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbeq_64_imm" << std::endl; return; }
...
void test_cbne_64_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbne_64_imm" << std::endl; return; }
...
void test_cbgt_32_regs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbgt_32_regs" << std::endl; return; }
...
void test_cbge_32_regs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbge_32_regs" << std::endl; return; }
...
void test_cbhi_32_regs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbhi_32_regs" << std::endl; return; }
...
void test_cbhs_32_regs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbhs_32_regs" << std::endl; return; }
...
void test_cbeq_32_regs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbeq_32_regs" << std::endl; return; }
...
void test_cbne_32_regs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbne_32_regs" << std::endl; return; }
...
void test_cbgt_64_regs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbgt_64_regs" << std::endl; return; }
...
void test_cbge_64_regs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbge_64_regs" << std::endl; return; }
...
void test_cbhi_64_regs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbhi_64_regs" << std::endl; return; }
...
void test_cbhs_64_regs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbhs_64_regs" << std::endl; return; }
...
void test_cbeq_64_regs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbeq_64_regs" << std::endl; return; }
...
void test_cbne_64_regs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbne_64_regs" << std::endl; return; }
...
void test_cbge_cbgt_32_imm() {
    uint32_t insn = 0x75000000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbge_cbgt_32_imm" << std::endl; return; }
...
void test_cbge_cbgt_64_imm() {
    uint32_t insn = 0xF5000000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbge_cbgt_64_imm" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CBGT);
...
void test_cbhgt_16_regs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbhgt_16_regs" << std::endl; return; }
...
void test_cbhge_16_regs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbhge_16_regs" << std::endl; return; }
...
void test_cbhhi_16_regs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbhhi_16_regs" << std::endl; return; }
...
void test_cbhhs_16_regs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbhhs_16_regs" << std::endl; return; }
...
void test_cbheq_16_regs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbheq_16_regs" << std::endl; return; }
...
void test_cbhne_16_regs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbhne_16_regs" << std::endl; return; }
...
void test_cbhle_cbhge_16_regs() {
    uint32_t insn = 0x7420C000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbhle_cbhge_16_regs" << std::endl; return; }
...
void test_cbhlo_cbhhi_16_regs() {
    uint32_t insn = 0x7440C000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbhlo_cbhhi_16_regs" << std::endl; return; }
...
void test_cbhls_cbhhs_16_regs() {
    uint32_t insn = 0x7460C000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbhls_cbhhs_16_regs" << std::endl; return; }
...
void test_cbhlt_cbhgt_16_regs() {
    uint32_t insn = 0x7400C000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbhlt_cbhgt_16_regs" << std::endl; return; }
...
void test_cbhs_cbhi_32_imm() {
    uint32_t insn = 0x75400000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbhs_cbhi_32_imm" << std::endl; return; }
...
void test_cbhs_cbhi_64_imm() {
    uint32_t insn = 0xF5400000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbhs_cbhi_64_imm" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CBHI);
...
void test_cble_cblt_32_imm() {
    uint32_t insn = 0x75200000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cble_cblt_32_imm" << std::endl; return; }
...
void test_cble_cblt_64_imm() {
    uint32_t insn = 0xF5200000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cble_cblt_64_imm" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CBLT);
...
void test_cble_cbge_32_regs() {
    uint32_t insn = 0x74200000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cble_cbge_32_regs" << std::endl; return; }
...
void test_cble_cbge_64_regs() {
    uint32_t insn = 0xF4200000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cble_cbge_64_regs" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CBGE);
...
void test_cblo_cbhi_32_regs() {
    uint32_t insn = 0x74400000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cblo_cbhi_32_regs" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CBHI);
...
void test_cblo_cbhi_64_regs() {
    uint32_t insn = 0xF4400000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cblo_cbhi_64_regs" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CBHI);
...
void test_cbls_cblo_32_imm() {
    uint32_t insn = 0x75600000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbls_cblo_32_imm" << std::endl; return; }
...
void test_cbls_cblo_64_imm() {
    uint32_t insn = 0xF5600000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbls_cblo_64_imm" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CBLO);
...
void test_cbls_cbhs_32_regs() {
    uint32_t insn = 0x74600000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbls_cbhs_32_regs" << std::endl; return; }
...
void test_cbls_cbhs_64_regs() {
    uint32_t insn = 0xF4600000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbls_cbhs_64_regs" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CBHS);
...
void test_cblt_cbgt_32_regs() {
    uint32_t insn = 0x74000000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cblt_cbgt_32_regs" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CBGT);
...
void test_cblt_cbgt_64_regs() {
    uint32_t insn = 0xF4000000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cblt_cbgt_64_regs" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CBGT);
...
void test_cbnz_32_compbranch() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbnz_32_compbranch" << std::endl; return; }
...
void test_cbnz_64_compbranch() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbnz_64_compbranch" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CBNZ);
...
void test_cbz_32_compbranch() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbz_32_compbranch" << std::endl; return; }
...
void test_cbz_64_compbranch() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cbz_64_compbranch" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CBZ);
...
void test_cfinv_m_pstate() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cfinv_m_pstate" << std::endl; return; }
...
void test_cfp_sys_cr_systeminstrs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cfp_sys_cr_systeminstrs" << std::endl; return; }
...
void test_chkfeat_hf_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: chkfeat_hf_hints" << std::endl; return; }
...
void test_clrbhb_hi_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: clrbhb_hi_hints" << std::endl; return; }
...
void test_clrex_bn_barriers() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: clrex_bn_barriers" << std::endl; return; }
...
void test_cosp_sys_cr_systeminstrs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cosp_sys_cr_systeminstrs" << std::endl; return; }
...
void test_cpp_sys_cr_systeminstrs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cpp_sys_cr_systeminstrs" << std::endl; return; }
...
void test_csdb_hi_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: csdb_hi_hints" << std::endl; return; }
...
void test_dc_sys_cr_systeminstrs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: dc_sys_cr_systeminstrs" << std::endl; return; }
...
void test_dcps1_dc_exception() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: dcps1_dc_exception" << std::endl; return; }
...
void test_dcps2_dc_exception() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: dcps2_dc_exception" << std::endl; return; }
...
void test_dcps3_dc_exception() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: dcps3_dc_exception" << std::endl; return; }
...
void test_dgh_hi_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: dgh_hi_hints" << std::endl; return; }
...
void test_dmb_bo_barriers() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: dmb_bo_barriers" << std::endl; return; }
...
void test_drps_64e_branch_reg() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: drps_64e_branch_reg" << std::endl; return; }
...
void test_dsb_bo_barriers() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: dsb_bo_barriers" << std::endl; return; }
...
void test_dsb_bon_barriers() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: dsb_bon_barriers" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::DSB);
...
void test_dvp_sys_cr_systeminstrs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: dvp_sys_cr_systeminstrs" << std::endl; return; }
...
void test_eret_64e_branch_reg() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: eret_64e_branch_reg" << std::endl; return; }
...
void test_eretaa_64e_branch_reg() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: eretaa_64e_branch_reg" << std::endl; return; }
...
void test_eretab_64e_branch_reg() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: eretab_64e_branch_reg" << std::endl; return; }
...
void test_esb_hi_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: esb_hi_hints" << std::endl; return; }
...
void test_gcsb_hd_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: gcsb_hd_hints" << std::endl; return; }
...
void test_gcspopcx_sys_cr_systeminstrs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: gcspopcx_sys_cr_systeminstrs" << std::endl; return; }
...
void test_gcspopm_sysl_rc_systeminstrs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: gcspopm_sysl_rc_systeminstrs" << std::endl; return; }
...
void test_gcspopx_sys_cr_systeminstrs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: gcspopx_sys_cr_systeminstrs" << std::endl; return; }
...
void test_gcspushm_sys_cr_systeminstrs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: gcspushm_sys_cr_systeminstrs" << std::endl; return; }
...
void test_gcspushx_sys_cr_systeminstrs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: gcspushx_sys_cr_systeminstrs" << std::endl; return; }
...
void test_gcsss1_sys_cr_systeminstrs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: gcsss1_sys_cr_systeminstrs" << std::endl; return; }
...
void test_gcsss2_sysl_rc_systeminstrs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: gcsss2_sysl_rc_systeminstrs" << std::endl; return; }
...
void test_gic_sys_cr_systeminstrs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: gic_sys_cr_systeminstrs" << std::endl; return; }
...
void test_gicr_sysl_rc_systeminstrs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: gicr_sysl_rc_systeminstrs" << std::endl; return; }
...
void test_gsb_sys_cr_systeminstrs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: gsb_sys_cr_systeminstrs" << std::endl; return; }
...
void test_hint_hm_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: hint_hm_hints" << std::endl; return; }
...
void test_hlt_ex_exception() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: hlt_ex_exception" << std::endl; return; }
...
void test_hvc_ex_exception() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: hvc_ex_exception" << std::endl; return; }
...
void test_ic_sys_cr_systeminstrs() {
    uint32_t insn = 0xD5087000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ic_sys_cr_systeminstrs" << std::endl; return; }
...
void test_isb_bi_barriers() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: isb_bi_barriers" << std::endl; return; }
...
void test_mlbi_sys_cr_systeminstrs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mlbi_sys_cr_systeminstrs" << std::endl; return; }
...
void test_mrrs_rs_systemmovepr() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mrrs_rs_systemmovepr" << std::endl; return; }
...
void test_mrs_rs_systemmove() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mrs_rs_systemmove" << std::endl; return; }
...
void test_msr_si_pstate() {
    uint32_t insn = 0xD500401Fu;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: msr_si_pstate" << std::endl; return; }
...
void test_msr_sr_systemmove() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: msr_sr_systemmove" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::MSR);
...
void test_msrr_sr_systemmovepr() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: msrr_sr_systemmovepr" << std::endl; return; }
...
void test_nop_hi_hints() {
    uint32_t insn = 0xD503201Fu;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: nop_hi_hints" << std::endl; return; }
...
void test_pacia1716_hi_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: pacia1716_hi_hints" << std::endl; return; }
...
void test_paciasp_hi_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: paciasp_hi_hints" << std::endl; return; }
...
void test_paciaz_hi_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: paciaz_hi_hints" << std::endl; return; }
...
void test_pacib1716_hi_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: pacib1716_hi_hints" << std::endl; return; }
...
void test_pacibsp_hi_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: pacibsp_hi_hints" << std::endl; return; }
...
void test_pacibz_hi_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: pacibz_hi_hints" << std::endl; return; }
...
void test_pacm_hi_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: pacm_hi_hints" << std::endl; return; }
...
void test_psb_hc_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: psb_hc_hints" << std::endl; return; }
...
void test_pssbb_dsb_bo_barriers() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: pssbb_dsb_bo_barriers" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::DSB);
...
void test_ret_64r_branch_reg() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ret_64r_branch_reg" << std::endl; return; }
...
void test_retaa_64e_branch_reg() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: retaa_64e_branch_reg" << std::endl; return; }
...
void test_retab_64e_branch_reg() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: retab_64e_branch_reg" << std::endl; return; }
...
void test_retaasppc_only_miscbranch() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: retaasppc_only_miscbranch" << std::endl; return; }
...
void test_retabsppc_only_miscbranch() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: retabsppc_only_miscbranch" << std::endl; return; }
...
void test_retaasppcr_64m_branch_reg() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: retaasppcr_64m_branch_reg" << std::endl; return; }
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::Register);
...
void test_retabsppcr_64m_branch_reg() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: retabsppcr_64m_branch_reg" << std::endl; return; }
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::Register);
...
void test_sb_only_barriers() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sb_only_barriers" << std::endl; return; }
...
void test_sev_hi_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sev_hi_hints" << std::endl; return; }
...
void test_sevl_hi_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sevl_hi_hints" << std::endl; return; }
...
void test_shuh_hi_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: shuh_hi_hints" << std::endl; return; }
...
void test_smc_ex_exception() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smc_ex_exception" << std::endl; return; }
...
void test_smstart_msr_si_pstate() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smstart_msr_si_pstate" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::MSR);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_smstop_msr_si_pstate() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smstop_msr_si_pstate" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::MSR);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_ssbb_dsb_bo_barriers() {
    uint32_t insn = 0xD503309Fu;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ssbb_dsb_bo_barriers" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::DSB);
...
void test_stcph_hi_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: stcph_hi_hints" << std::endl; return; }
...
void test_stshh_hi_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: stshh_hi_hints" << std::endl; return; }
...
void test_svc_ex_exception() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: svc_ex_exception" << std::endl; return; }
...
void test_sys_cr_systeminstrs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sys_cr_systeminstrs" << std::endl; return; }
...
void test_sysl_rc_systeminstrs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sysl_rc_systeminstrs" << std::endl; return; }
...
void test_sysp_cr_syspairinstrs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sysp_cr_syspairinstrs" << std::endl; return; }
...
void test_tbnz_only_testbranch() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: tbnz_only_testbranch" << std::endl; return; }
...
void test_tbz_only_testbranch() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: tbz_only_testbranch" << std::endl; return; }
...
void test_tlbi_sys_cr_systeminstrs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: tlbi_sys_cr_systeminstrs" << std::endl; return; }
...
void test_tlbip_sysp_cr_syspairinstrs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: tlbip_sysp_cr_syspairinstrs" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SYSP);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_trcit_sys_cr_systeminstrs() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: trcit_sys_cr_systeminstrs" << std::endl; return; }
...
void test_tsb_hc_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: tsb_hc_hints" << std::endl; return; }
...
void test_wfe_hi_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: wfe_hi_hints" << std::endl; return; }
...
void test_wfet_only_systeminstrswithreg() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: wfet_only_systeminstrswithreg" << std::endl; return; }
...
void test_wfi_hi_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: wfi_hi_hints" << std::endl; return; }
...
void test_wfit_only_systeminstrswithreg() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: wfit_only_systeminstrswithreg" << std::endl; return; }
...
void test_xaflag_m_pstate() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: xaflag_m_pstate" << std::endl; return; }
...
void test_xpaclri_hi_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: xpaclri_hi_hints" << std::endl; return; }
...
void test_yield_hi_hints() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: yield_hi_hints" << std::endl; return; }
