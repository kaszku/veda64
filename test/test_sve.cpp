...
void test_abs_z_p_z_m() {
    ...
    if (!result.has_value()) { std::cerr << "DECODE FAIL: abs_z_p_z_m" << std::endl; return; }
...
void test_abs_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: abs_z_p_z_z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ABS);
...
void test_adclb_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: adclb_z_zzz_" << std::endl; return; }
...
void test_adclt_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: adclt_z_zzz_" << std::endl; return; }
...
void test_add_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: add_z_p_zz_" << std::endl; return; }
...
void test_add_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: add_z_zi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ADD);
...
void test_add_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: add_z_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ADD);
...
void test_addhnb_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: addhnb_z_zz_" << std::endl; return; }
...
void test_addhnt_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: addhnt_z_zz_" << std::endl; return; }
...
void test_addp_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: addp_z_p_zz_" << std::endl; return; }
...
void test_addpl_r_ri_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: addpl_r_ri_" << std::endl; return; }
...
void test_addpt_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: addpt_z_p_zz_" << std::endl; return; }
...
void test_addpt_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: addpt_z_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ADDPT);
...
void test_addqp_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: addqp_z_zz_" << std::endl; return; }
...
void test_addqv_z_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: addqv_z_p_z_" << std::endl; return; }
...
void test_addspl_r_ri_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: addspl_r_ri_" << std::endl; return; }
...
void test_addsubp_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: addsubp_z_zz_" << std::endl; return; }
...
void test_addsvl_r_ri_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: addsvl_r_ri_" << std::endl; return; }
...
void test_addvl_r_ri_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: addvl_r_ri_" << std::endl; return; }
...
void test_adr_z_az_sd_same_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: adr_z_az_sd_same_scaled" << std::endl; return; }
...
void test_adr_z_az_d_s32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: adr_z_az_d_s32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ADR);
...
void test_adr_z_az_d_u32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: adr_z_az_d_u32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ADR);
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::MemoryRegOffset);
...
void test_aesd_mz_zzi_2x1() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: aesd_mz_zzi_2x1" << std::endl; return; }
...
void test_aesd_mz_zzi_4x1() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: aesd_mz_zzi_4x1" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::AESD);
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_aesd_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: aesd_z_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::AESD);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_aesdimc_mz_zzi_2x1() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: aesdimc_mz_zzi_2x1" << std::endl; return; }
...
void test_aesdimc_mz_zzi_4x1() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: aesdimc_mz_zzi_4x1" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::AESDIMC);
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_aese_mz_zzi_2x1() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: aese_mz_zzi_2x1" << std::endl; return; }
...
void test_aese_mz_zzi_4x1() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: aese_mz_zzi_4x1" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::AESE);
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_aese_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: aese_z_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::AESE);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_aesemc_mz_zzi_2x1() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: aesemc_mz_zzi_2x1" << std::endl; return; }
...
void test_aesemc_mz_zzi_4x1() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: aesemc_mz_zzi_4x1" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::AESEMC);
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_aesimc_z_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: aesimc_z_z_" << std::endl; return; }
...
void test_aesmc_z_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: aesmc_z_z_" << std::endl; return; }
...
void test_and_p_p_pp_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: and_p_p_pp_z" << std::endl; return; }
...
void test_and_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: and_z_p_zz_" << std::endl; return; }
...
void test_and_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: and_z_zi_" << std::endl; return; }
...
void test_and_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: and_z_zz_" << std::endl; return; }
...
void test_andqv_z_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: andqv_z_p_z_" << std::endl; return; }
...
void test_ands_p_p_pp_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ands_p_p_pp_z" << std::endl; return; }
...
void test_andv_r_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: andv_r_p_z_" << std::endl; return; }
...
void test_asr_z_p_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: asr_z_p_zi_" << std::endl; return; }
...
void test_asr_z_p_zw_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: asr_z_p_zw_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ASR);
...
void test_asr_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: asr_z_p_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ASR);
...
void test_asr_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: asr_z_zi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ASR);
...
void test_asr_z_zw_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: asr_z_zw_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ASR);
...
void test_asrd_z_p_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: asrd_z_p_zi_" << std::endl; return; }
...
void test_asrr_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: asrr_z_p_zz_" << std::endl; return; }
...
void test_bcax_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bcax_z_zzz_" << std::endl; return; }
...
void test_bdep_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bdep_z_zz_" << std::endl; return; }
...
void test_bext_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bext_z_zz_" << std::endl; return; }
...
void test_bf1cvt_z_z8_b2bf() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bf1cvt_z_z8_b2bf" << std::endl; return; }
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_bf2cvt_z_z8_b2bf() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bf2cvt_z_z8_b2bf" << std::endl; return; }
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_bf1cvtlt_z_z8_b2bf() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bf1cvtlt_z_z8_b2bf" << std::endl; return; }
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_bf2cvtlt_z_z8_b2bf() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bf2cvtlt_z_z8_b2bf" << std::endl; return; }
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_bfadd_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfadd_z_p_zz_" << std::endl; return; }
...
void test_bfadd_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfadd_z_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::BFADD);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_bfclamp_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfclamp_z_zz_" << std::endl; return; }
...
void test_bfcvt_z_p_z_s2bf() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfcvt_z_p_z_s2bf" << std::endl; return; }
...
void test_bfcvt_z_p_z_s2bfz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfcvt_z_p_z_s2bfz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::BFCVT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_bfcvtn_z8_mz2_bf2b() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfcvtn_z8_mz2_bf2b" << std::endl; return; }
...
void test_bfcvtnt_z_p_z_s2bf() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfcvtnt_z_p_z_s2bf" << std::endl; return; }
...
void test_bfcvtnt_z_p_z_s2bfz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfcvtnt_z_p_z_s2bfz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::BFCVTNT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_bfdot_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfdot_z_zzz_" << std::endl; return; }
...
void test_bfdot_z_zzzi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfdot_z_zzzi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::BFDOT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_bfmax_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfmax_z_p_zz_" << std::endl; return; }
...
void test_bfmaxnm_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfmaxnm_z_p_zz_" << std::endl; return; }
...
void test_bfmin_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfmin_z_p_zz_" << std::endl; return; }
...
void test_bfminnm_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfminnm_z_p_zz_" << std::endl; return; }
...
void test_bfmla_z_p_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfmla_z_p_zzz_" << std::endl; return; }
...
void test_bfmla_z_zzzi_h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfmla_z_zzzi_h" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::BFMLA);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_bfmlalb_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfmlalb_z_zzz_" << std::endl; return; }
...
void test_bfmlalb_z_zzzi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfmlalb_z_zzzi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::BFMLALB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_bfmlalt_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfmlalt_z_zzz_" << std::endl; return; }
...
void test_bfmlalt_z_zzzi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfmlalt_z_zzzi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::BFMLALT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_bfmls_z_p_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfmls_z_p_zzz_" << std::endl; return; }
...
void test_bfmls_z_zzzi_h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfmls_z_zzzi_h" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::BFMLS);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_bfmlslb_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfmlslb_z_zzz_" << std::endl; return; }
...
void test_bfmlslb_z_zzzi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfmlslb_z_zzzi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::BFMLSLB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_bfmlslt_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfmlslt_z_zzz_" << std::endl; return; }
...
void test_bfmlslt_z_zzzi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfmlslt_z_zzzi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::BFMLSLT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_bfmmla_z_zzz_h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfmmla_z_zzz_h" << std::endl; return; }
...
void test_bfmmla_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfmmla_z_zzz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::BFMMLA);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_bfmul_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfmul_z_p_zz_" << std::endl; return; }
...
void test_bfmul_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfmul_z_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::BFMUL);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_bfmul_z_zzi_h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfmul_z_zzi_h" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::BFMUL);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_bfscale_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfscale_z_p_zz_" << std::endl; return; }
...
void test_bfsub_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfsub_z_p_zz_" << std::endl; return; }
...
void test_bfsub_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfsub_z_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::BFSUB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_bgrp_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bgrp_z_zz_" << std::endl; return; }
...
void test_bic_z_zi__and_z_zi_() {
    uint32_t insn = 0x05800000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bic_z_zi__and_z_zi_" << std::endl; return; }
...
void test_bic_p_p_pp_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bic_p_p_pp_z" << std::endl; return; }
...
void test_bic_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bic_z_p_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::BIC);
...
void test_bic_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bic_z_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::BIC);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_bics_p_p_pp_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bics_p_p_pp_z" << std::endl; return; }
...
void test_brka_p_p_p_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: brka_p_p_p_" << std::endl; return; }
...
void test_brkas_p_p_p_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: brkas_p_p_p_z" << std::endl; return; }
...
void test_brkb_p_p_p_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: brkb_p_p_p_" << std::endl; return; }
...
void test_brkbs_p_p_p_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: brkbs_p_p_p_z" << std::endl; return; }
...
void test_brkn_p_p_pp_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: brkn_p_p_pp_" << std::endl; return; }
...
void test_brkns_p_p_pp_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: brkns_p_p_pp_" << std::endl; return; }
...
void test_brkpa_p_p_pp_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: brkpa_p_p_pp_" << std::endl; return; }
...
void test_brkpas_p_p_pp_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: brkpas_p_p_pp_" << std::endl; return; }
...
void test_brkpb_p_p_pp_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: brkpb_p_p_pp_" << std::endl; return; }
...
void test_brkpbs_p_p_pp_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: brkpbs_p_p_pp_" << std::endl; return; }
...
void test_bsl1n_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bsl1n_z_zzz_" << std::endl; return; }
...
void test_bsl2n_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bsl2n_z_zzz_" << std::endl; return; }
...
void test_bsl_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bsl_z_zzz_" << std::endl; return; }
...
void test_cadd_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cadd_z_zz_" << std::endl; return; }
...
void test_cdot_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cdot_z_zzz_" << std::endl; return; }
...
void test_cdot_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cdot_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CDOT);
...
void test_cdot_z_zzzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cdot_z_zzzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CDOT);
...
void test_clasta_r_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: clasta_r_p_z_" << std::endl; return; }
...
void test_clasta_v_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: clasta_v_p_z_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CLASTA);
...
void test_clasta_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: clasta_z_p_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CLASTA);
...
void test_clastb_r_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: clastb_r_p_z_" << std::endl; return; }
...
void test_clastb_v_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: clastb_v_p_z_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CLASTB);
...
void test_clastb_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: clastb_z_p_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CLASTB);
...
void test_cls_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cls_z_p_z_m" << std::endl; return; }
...
void test_cls_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cls_z_p_z_z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CLS);
...
void test_clz_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: clz_z_p_z_m" << std::endl; return; }
...
void test_clz_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: clz_z_p_z_z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CLZ);
...
void test_cmla_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmla_z_zzz_" << std::endl; return; }
...
void test_cmla_z_zzzi_h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmla_z_zzzi_h" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CMLA);
...
void test_cmla_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmla_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CMLA);
...
void test_cmpeq_p_p_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmpeq_p_p_zi_" << std::endl; return; }
...
void test_cmpgt_p_p_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmpgt_p_p_zi_" << std::endl; return; }
...
void test_cmpge_p_p_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmpge_p_p_zi_" << std::endl; return; }
...
void test_cmphi_p_p_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmphi_p_p_zi_" << std::endl; return; }
...
void test_cmphs_p_p_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmphs_p_p_zi_" << std::endl; return; }
...
void test_cmplt_p_p_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmplt_p_p_zi_" << std::endl; return; }
...
void test_cmple_p_p_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmple_p_p_zi_" << std::endl; return; }
...
void test_cmplo_p_p_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmplo_p_p_zi_" << std::endl; return; }
...
void test_cmpls_p_p_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmpls_p_p_zi_" << std::endl; return; }
...
void test_cmpne_p_p_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmpne_p_p_zi_" << std::endl; return; }
...
void test_cmpeq_p_p_zw_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmpeq_p_p_zw_" << std::endl; return; }
...
void test_cmpgt_p_p_zw_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmpgt_p_p_zw_" << std::endl; return; }
...
void test_cmpge_p_p_zw_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmpge_p_p_zw_" << std::endl; return; }
...
void test_cmphi_p_p_zw_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmphi_p_p_zw_" << std::endl; return; }
...
void test_cmphs_p_p_zw_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmphs_p_p_zw_" << std::endl; return; }
...
void test_cmplt_p_p_zw_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmplt_p_p_zw_" << std::endl; return; }
...
void test_cmple_p_p_zw_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmple_p_p_zw_" << std::endl; return; }
...
void test_cmplo_p_p_zw_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmplo_p_p_zw_" << std::endl; return; }
...
void test_cmpls_p_p_zw_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmpls_p_p_zw_" << std::endl; return; }
...
void test_cmpne_p_p_zw_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmpne_p_p_zw_" << std::endl; return; }
...
void test_cmpeq_p_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmpeq_p_p_zz_" << std::endl; return; }
...
void test_cmpgt_p_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmpgt_p_p_zz_" << std::endl; return; }
...
void test_cmpge_p_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmpge_p_p_zz_" << std::endl; return; }
...
void test_cmphi_p_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmphi_p_p_zz_" << std::endl; return; }
...
void test_cmphs_p_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmphs_p_p_zz_" << std::endl; return; }
...
void test_cmpne_p_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmpne_p_p_zz_" << std::endl; return; }
...
void test_cmple_p_p_zz__cmpge_p_p_zz_() {
    uint32_t insn = 0x24008000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmple_p_p_zz__cmpge_p_p_zz_" << std::endl; return; }
...
void test_cmplo_p_p_zz__cmphi_p_p_zz_() {
    uint32_t insn = 0x24000010u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmplo_p_p_zz__cmphi_p_p_zz_" << std::endl; return; }
...
void test_cmpls_p_p_zz__cmphs_p_p_zz_() {
    uint32_t insn = 0x24000000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmpls_p_p_zz__cmphs_p_p_zz_" << std::endl; return; }
...
void test_cmplt_p_p_zz__cmpgt_p_p_zz_() {
    uint32_t insn = 0x24008010u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmplt_p_p_zz__cmpgt_p_p_zz_" << std::endl; return; }
...
void test_cnot_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cnot_z_p_z_m" << std::endl; return; }
...
void test_cnot_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cnot_z_p_z_z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CNOT);
...
void test_cnt_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cnt_z_p_z_m" << std::endl; return; }
...
void test_cnt_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cnt_z_p_z_z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CNT);
...
void test_cntb_r_s_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cntb_r_s_" << std::endl; return; }
...
void test_cntd_r_s_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cntd_r_s_" << std::endl; return; }
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_cnth_r_s_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cnth_r_s_" << std::endl; return; }
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_cntw_r_s_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cntw_r_s_" << std::endl; return; }
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_cntp_r_p_p_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cntp_r_p_p_" << std::endl; return; }
...
void test_cntp_r_pn_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cntp_r_pn_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CNTP);
...
void test_compact_z_p_z_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: compact_z_p_z_s" << std::endl; return; }
...
void test_compact_z_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: compact_z_p_z_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::COMPACT);
...
void test_cpy_z_o_i_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cpy_z_o_i_" << std::endl; return; }
...
void test_cpy_z_p_i_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cpy_z_p_i_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CPY);
...
void test_cpy_z_p_r_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cpy_z_p_r_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CPY);
...
void test_cpy_z_p_v_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cpy_z_p_v_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CPY);
...
void test_ctermeq_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ctermeq_rr_" << std::endl; return; }
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ctermne_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ctermne_rr_" << std::endl; return; }
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_decb_r_rs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: decb_r_rs_" << std::endl; return; }
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_decd_r_rs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: decd_r_rs_" << std::endl; return; }
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_dech_r_rs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: dech_r_rs_" << std::endl; return; }
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_decw_r_rs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: decw_r_rs_" << std::endl; return; }
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_decd_z_zs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: decd_z_zs_" << std::endl; return; }
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_dech_z_zs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: dech_z_zs_" << std::endl; return; }
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_decw_z_zs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: decw_z_zs_" << std::endl; return; }
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_decp_r_p_r_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: decp_r_p_r_" << std::endl; return; }
...
void test_decp_z_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: decp_z_p_z_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::DECP);
...
void test_dup_z_i_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: dup_z_i_" << std::endl; return; }
...
void test_dup_z_r_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: dup_z_r_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::DUP);
...
void test_dup_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: dup_z_zi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::DUP);
...
void test_dupm_z_i_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: dupm_z_i_" << std::endl; return; }
...
void test_dupq_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: dupq_z_zi_" << std::endl; return; }
...
void test_eon_z_zi__eor_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: eon_z_zi__eor_z_zi_" << std::endl; return; }
...
void test_eor3_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: eor3_z_zzz_" << std::endl; return; }
...
void test_eor_p_p_pp_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: eor_p_p_pp_z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::EOR);
    assert(result->operands.size() >= 4);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_eor_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: eor_z_p_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::EOR);
...
void test_eor_z_zi_() {
    uint32_t insn = 0x05400000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: eor_z_zi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::EOR);
...
void test_eor_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: eor_z_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::EOR);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_eorbt_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: eorbt_z_zz_" << std::endl; return; }
...
void test_eorqv_z_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: eorqv_z_p_z_" << std::endl; return; }
...
void test_eors_p_p_pp_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: eors_p_p_pp_z" << std::endl; return; }
...
void test_eortb_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: eortb_z_zz_" << std::endl; return; }
...
void test_eorv_r_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: eorv_r_p_z_" << std::endl; return; }
...
void test_expand_z_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: expand_z_p_z_" << std::endl; return; }
...
void test_ext_z_zi_con() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ext_z_zi_con" << std::endl; return; }
...
void test_ext_z_zi_des() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ext_z_zi_des" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::EXT);
...
void test_extq_z_zi_des() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: extq_z_zi_des" << std::endl; return; }
...
void test_f1cvt_z_z8_b2h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: f1cvt_z_z8_b2h" << std::endl; return; }
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_f2cvt_z_z8_b2h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: f2cvt_z_z8_b2h" << std::endl; return; }
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_f1cvtlt_z_z8_b2h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: f1cvtlt_z_z8_b2h" << std::endl; return; }
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_f2cvtlt_z_z8_b2h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: f2cvtlt_z_z8_b2h" << std::endl; return; }
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fabd_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fabd_z_p_zz_" << std::endl; return; }
...
void test_fabs_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fabs_z_p_z_m" << std::endl; return; }
...
void test_fabs_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fabs_z_p_z_z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FABS);
...
void test_facgt_p_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: facgt_p_p_zz_" << std::endl; return; }
...
void test_facge_p_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: facge_p_p_zz_" << std::endl; return; }
...
void test_facle_p_p_zz__facge_p_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: facle_p_p_zz__facge_p_p_zz_" << std::endl; return; }
...
void test_faclt_p_p_zz__facgt_p_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: faclt_p_p_zz__facgt_p_p_zz_" << std::endl; return; }
...
void test_fadd_z_p_zs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fadd_z_p_zs_" << std::endl; return; }
...
void test_fadd_z_p_zz_() {
    uint32_t insn = 0x65008000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fadd_z_p_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FADD);
...
void test_fadd_z_zz_() {
    uint32_t insn = 0x65000000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fadd_z_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FADD);
...
void test_fadda_v_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fadda_v_p_z_" << std::endl; return; }
...
void test_faddp_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: faddp_z_p_zz_" << std::endl; return; }
...
void test_faddqv_z_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: faddqv_z_p_z_" << std::endl; return; }
...
void test_faddv_v_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: faddv_v_p_z_" << std::endl; return; }
...
void test_famax_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: famax_z_p_zz_" << std::endl; return; }
...
void test_famin_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: famin_z_p_zz_" << std::endl; return; }
...
void test_fcadd_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcadd_z_p_zz_" << std::endl; return; }
...
void test_fclamp_z_zz_() {
    uint32_t insn = 0x64202400u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fclamp_z_zz_" << std::endl; return; }
...
void test_fcmeq_p_p_z0_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcmeq_p_p_z0_" << std::endl; return; }
...
void test_fcmgt_p_p_z0_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcmgt_p_p_z0_" << std::endl; return; }
...
void test_fcmge_p_p_z0_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcmge_p_p_z0_" << std::endl; return; }
...
void test_fcmlt_p_p_z0_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcmlt_p_p_z0_" << std::endl; return; }
...
void test_fcmle_p_p_z0_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcmle_p_p_z0_" << std::endl; return; }
...
void test_fcmne_p_p_z0_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcmne_p_p_z0_" << std::endl; return; }
...
void test_fcmeq_p_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcmeq_p_p_zz_" << std::endl; return; }
...
void test_fcmgt_p_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcmgt_p_p_zz_" << std::endl; return; }
...
void test_fcmge_p_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcmge_p_p_zz_" << std::endl; return; }
...
void test_fcmne_p_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcmne_p_p_zz_" << std::endl; return; }
...
void test_fcmuo_p_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcmuo_p_p_zz_" << std::endl; return; }
...
void test_fcmla_z_p_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcmla_z_p_zzz_" << std::endl; return; }
...
void test_fcmla_z_zzzi_h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcmla_z_zzzi_h" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCMLA);
...
void test_fcmla_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcmla_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCMLA);
...
void test_fcmle_p_p_zz__fcmge_p_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcmle_p_p_zz__fcmge_p_p_zz_" << std::endl; return; }
...
void test_fcmlt_p_p_zz__fcmgt_p_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcmlt_p_p_zz__fcmgt_p_p_zz_" << std::endl; return; }
...
void test_fcpy_z_p_i_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcpy_z_p_i_" << std::endl; return; }
...
void test_fcvt_z_p_z_h2s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvt_z_p_z_h2s" << std::endl; return; }
...
void test_fcvt_z_p_z_h2sz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvt_z_p_z_h2sz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvt_z_p_z_h2d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvt_z_p_z_h2d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvt_z_p_z_h2dz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvt_z_p_z_h2dz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvt_z_p_z_s2h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvt_z_p_z_s2h" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvt_z_p_z_s2hz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvt_z_p_z_s2hz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvt_z_p_z_s2d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvt_z_p_z_s2d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvt_z_p_z_s2dz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvt_z_p_z_s2dz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvt_z_p_z_d2h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvt_z_p_z_d2h" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvt_z_p_z_d2hz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvt_z_p_z_d2hz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvt_z_p_z_d2s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvt_z_p_z_d2s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvt_z_p_z_d2sz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvt_z_p_z_d2sz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtlt_z_p_z_h2s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtlt_z_p_z_h2s" << std::endl; return; }
...
void test_fcvtlt_z_p_z_h2sz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtlt_z_p_z_h2sz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTLT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtlt_z_p_z_s2d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtlt_z_p_z_s2d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTLT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtlt_z_p_z_s2dz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtlt_z_p_z_s2dz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTLT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtn_z8_mz2_h2b() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtn_z8_mz2_h2b" << std::endl; return; }
...
void test_fcvtnb_z8_mz2_s2b() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtnb_z8_mz2_s2b" << std::endl; return; }
...
void test_fcvtnt_z8_mz2_s2b() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtnt_z8_mz2_s2b" << std::endl; return; }
...
void test_fcvtnt_z_p_z_s2h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtnt_z_p_z_s2h" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTNT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtnt_z_p_z_s2hz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtnt_z_p_z_s2hz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTNT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtnt_z_p_z_d2s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtnt_z_p_z_d2s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTNT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtnt_z_p_z_d2sz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtnt_z_p_z_d2sz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTNT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtx_z_p_z_d2s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtx_z_p_z_d2s" << std::endl; return; }
...
void test_fcvtx_z_p_z_d2sz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtx_z_p_z_d2sz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTX);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtxnt_z_p_z_d2s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtxnt_z_p_z_d2s" << std::endl; return; }
...
void test_fcvtxnt_z_p_z_d2sz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtxnt_z_p_z_d2sz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTXNT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtzs_z_p_z_fp162h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzs_z_p_z_fp162h" << std::endl; return; }
...
void test_fcvtzs_z_p_z_fp162hz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzs_z_p_z_fp162hz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTZS);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtzs_z_p_z_fp162w() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzs_z_p_z_fp162w" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTZS);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtzs_z_p_z_fp162wz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzs_z_p_z_fp162wz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTZS);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtzs_z_p_z_fp162x() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzs_z_p_z_fp162x" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTZS);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtzs_z_p_z_fp162xz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzs_z_p_z_fp162xz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTZS);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtzs_z_p_z_s2w() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzs_z_p_z_s2w" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTZS);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtzs_z_p_z_s2wz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzs_z_p_z_s2wz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTZS);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtzs_z_p_z_s2x() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzs_z_p_z_s2x" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTZS);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtzs_z_p_z_s2xz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzs_z_p_z_s2xz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTZS);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtzs_z_p_z_d2w() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzs_z_p_z_d2w" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTZS);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtzs_z_p_z_d2wz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzs_z_p_z_d2wz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTZS);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtzs_z_p_z_d2x() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzs_z_p_z_d2x" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTZS);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtzs_z_p_z_d2xz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzs_z_p_z_d2xz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTZS);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtzsn_z_mz2_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzsn_z_mz2_" << std::endl; return; }
...
void test_fcvtzu_z_p_z_fp162h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzu_z_p_z_fp162h" << std::endl; return; }
...
void test_fcvtzu_z_p_z_fp162hz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzu_z_p_z_fp162hz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTZU);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtzu_z_p_z_fp162w() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzu_z_p_z_fp162w" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTZU);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtzu_z_p_z_fp162wz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzu_z_p_z_fp162wz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTZU);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtzu_z_p_z_fp162x() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzu_z_p_z_fp162x" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTZU);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtzu_z_p_z_fp162xz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzu_z_p_z_fp162xz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTZU);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtzu_z_p_z_s2w() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzu_z_p_z_s2w" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTZU);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtzu_z_p_z_s2wz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzu_z_p_z_s2wz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTZU);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtzu_z_p_z_s2x() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzu_z_p_z_s2x" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTZU);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtzu_z_p_z_s2xz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzu_z_p_z_s2xz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTZU);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtzu_z_p_z_d2w() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzu_z_p_z_d2w" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTZU);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtzu_z_p_z_d2wz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzu_z_p_z_d2wz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTZU);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtzu_z_p_z_d2x() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzu_z_p_z_d2x" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTZU);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtzu_z_p_z_d2xz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzu_z_p_z_d2xz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCVTZU);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fcvtzun_z_mz2_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fcvtzun_z_mz2_" << std::endl; return; }
...
void test_fdiv_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fdiv_z_p_zz_" << std::endl; return; }
...
void test_fdivr_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fdivr_z_p_zz_" << std::endl; return; }
...
void test_fdot_z32_zz8z8_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fdot_z32_zz8z8_" << std::endl; return; }
...
void test_fdot_z32_zz8z8i_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fdot_z32_zz8z8i_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FDOT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fdot_z_zz8z8_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fdot_z_zz8z8_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FDOT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fdot_z_zz8z8i_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fdot_z_zz8z8i_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FDOT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fdot_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fdot_z_zzz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FDOT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fdot_z_zzzi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fdot_z_zzzi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FDOT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fdup_z_i_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fdup_z_i_" << std::endl; return; }
...
void test_fexpa_z_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fexpa_z_z_" << std::endl; return; }
...
void test_firstp_r_p_p_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: firstp_r_p_p_" << std::endl; return; }
...
void test_flogb_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: flogb_z_p_z_m" << std::endl; return; }
...
void test_flogb_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: flogb_z_p_z_z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FLOGB);
...
void test_fmad_z_p_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmad_z_p_zzz_" << std::endl; return; }
...
void test_fmax_z_p_zs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmax_z_p_zs_" << std::endl; return; }
...
void test_fmax_z_p_zz_() {
    uint32_t insn = 0x65068000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmax_z_p_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMAX);
...
void test_fmaxnm_z_p_zs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmaxnm_z_p_zs_" << std::endl; return; }
...
void test_fmaxnm_z_p_zz_() {
    uint32_t insn = 0x65048000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmaxnm_z_p_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMAXNM);
...
void test_fmaxnmp_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmaxnmp_z_p_zz_" << std::endl; return; }
...
void test_fmaxnmqv_z_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmaxnmqv_z_p_z_" << std::endl; return; }
...
void test_fmaxnmv_v_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmaxnmv_v_p_z_" << std::endl; return; }
...
void test_fmaxp_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmaxp_z_p_zz_" << std::endl; return; }
...
void test_fmaxqv_z_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmaxqv_z_p_z_" << std::endl; return; }
...
void test_fmaxv_v_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmaxv_v_p_z_" << std::endl; return; }
...
void test_fmin_z_p_zs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmin_z_p_zs_" << std::endl; return; }
...
void test_fmin_z_p_zz_() {
    uint32_t insn = 0x65078000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmin_z_p_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMIN);
...
void test_fminnm_z_p_zs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fminnm_z_p_zs_" << std::endl; return; }
...
void test_fminnm_z_p_zz_() {
    uint32_t insn = 0x65058000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fminnm_z_p_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMINNM);
...
void test_fminnmp_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fminnmp_z_p_zz_" << std::endl; return; }
...
void test_fminnmqv_z_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fminnmqv_z_p_z_" << std::endl; return; }
...
void test_fminnmv_v_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fminnmv_v_p_z_" << std::endl; return; }
...
void test_fminp_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fminp_z_p_zz_" << std::endl; return; }
...
void test_fminqv_z_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fminqv_z_p_z_" << std::endl; return; }
...
void test_fminv_v_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fminv_v_p_z_" << std::endl; return; }
...
void test_fmla_z_p_zzz_() {
    uint32_t insn = 0x65200000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmla_z_p_zzz_" << std::endl; return; }
...
void test_fmla_z_zzzi_h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmla_z_zzzi_h" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMLA);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fmla_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmla_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMLA);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fmla_z_zzzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmla_z_zzzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMLA);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fmlalb_z_z8z8z8_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmlalb_z_z8z8z8_" << std::endl; return; }
...
void test_fmlalb_z_z8z8z8i_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmlalb_z_z8z8z8i_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMLALB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fmlalb_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmlalb_z_zzz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMLALB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fmlalb_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmlalb_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMLALB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fmlallbb_z32_z8z8z8_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmlallbb_z32_z8z8z8_" << std::endl; return; }
...
void test_fmlallbb_z32_z8z8z8i_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmlallbb_z32_z8z8z8i_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMLALLBB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fmlallbt_z32_z8z8z8_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmlallbt_z32_z8z8z8_" << std::endl; return; }
...
void test_fmlallbt_z32_z8z8z8i_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmlallbt_z32_z8z8z8i_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMLALLBT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fmlalltb_z32_z8z8z8_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmlalltb_z32_z8z8z8_" << std::endl; return; }
...
void test_fmlalltb_z32_z8z8z8i_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmlalltb_z32_z8z8z8i_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMLALLTB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fmlalltt_z32_z8z8z8_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmlalltt_z32_z8z8z8_" << std::endl; return; }
...
void test_fmlalltt_z32_z8z8z8i_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmlalltt_z32_z8z8z8i_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMLALLTT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fmlalt_z_z8z8z8_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmlalt_z_z8z8z8_" << std::endl; return; }
...
void test_fmlalt_z_z8z8z8i_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmlalt_z_z8z8z8i_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMLALT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fmlalt_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmlalt_z_zzz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMLALT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fmlalt_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmlalt_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMLALT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fmls_z_p_zzz_() {
    uint32_t insn = 0x65202000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmls_z_p_zzz_" << std::endl; return; }
...
void test_fmls_z_zzzi_h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmls_z_zzzi_h" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMLS);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fmls_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmls_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMLS);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fmls_z_zzzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmls_z_zzzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMLS);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fmlslb_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmlslb_z_zzz_" << std::endl; return; }
...
void test_fmlslb_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmlslb_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMLSLB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fmlslt_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmlslt_z_zzz_" << std::endl; return; }
...
void test_fmlslt_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmlslt_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMLSLT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fmmla_z16_zz8z8_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmmla_z16_zz8z8_" << std::endl; return; }
...
void test_fmmla_z32_zz8z8_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmmla_z32_zz8z8_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMMLA);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fmmla_z32_zzz_h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmmla_z32_zzz_h" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMMLA);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fmmla_z_zzz_h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmmla_z_zzz_h" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMMLA);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fmmla_z_zzz_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmmla_z_zzz_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMMLA);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fmmla_z_zzz_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmmla_z_zzz_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMMLA);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fmov_z_p_0__cpy_z_p_i_() {
    uint32_t insn = 0x05104000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmov_z_p_0__cpy_z_p_i_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CPY);
...
void test_fmov_z_0__dup_z_i_() {
    uint32_t insn = 0x2538C000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmov_z_0__dup_z_i_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::DUP);
...
void test_fmov_z_p_i__fcpy_z_p_i_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmov_z_p_i__fcpy_z_p_i_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FCPY);
...
void test_fmov_z_i__fdup_z_i_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmov_z_i__fdup_z_i_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FDUP);
...
void test_fmsb_z_p_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmsb_z_p_zzz_" << std::endl; return; }
...
void test_fmul_z_p_zs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmul_z_p_zs_" << std::endl; return; }
...
void test_fmul_z_p_zz_() {
    uint32_t insn = 0x65028000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmul_z_p_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMUL);
...
void test_fmul_z_zz_() {
    uint32_t insn = 0x65000800u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmul_z_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMUL);
...
void test_fmul_z_zzi_h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmul_z_zzi_h" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMUL);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fmul_z_zzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmul_z_zzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMUL);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fmul_z_zzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmul_z_zzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FMUL);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_fmulx_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fmulx_z_p_zz_" << std::endl; return; }
...
void test_fneg_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fneg_z_p_z_m" << std::endl; return; }
...
void test_fneg_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fneg_z_p_z_z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FNEG);
...
void test_fnmad_z_p_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fnmad_z_p_zzz_" << std::endl; return; }
...
void test_fnmla_z_p_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fnmla_z_p_zzz_" << std::endl; return; }
...
void test_fnmls_z_p_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fnmls_z_p_zzz_" << std::endl; return; }
...
void test_fnmsb_z_p_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fnmsb_z_p_zzz_" << std::endl; return; }
...
void test_frecpe_z_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: frecpe_z_z_" << std::endl; return; }
...
void test_frecps_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: frecps_z_zz_" << std::endl; return; }
...
void test_frecpx_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: frecpx_z_p_z_m" << std::endl; return; }
...
void test_frecpx_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: frecpx_z_p_z_z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FRECPX);
...
void test_frint32x_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: frint32x_z_p_z_m" << std::endl; return; }
...
void test_frint32x_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: frint32x_z_p_z_z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FRINT32X);
...
void test_frint32z_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: frint32z_z_p_z_m" << std::endl; return; }
...
void test_frint32z_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: frint32z_z_p_z_z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FRINT32Z);
...
void test_frint64x_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: frint64x_z_p_z_m" << std::endl; return; }
...
void test_frint64x_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: frint64x_z_p_z_z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FRINT64X);
...
void test_frint64z_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: frint64z_z_p_z_m" << std::endl; return; }
...
void test_frint64z_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: frint64z_z_p_z_z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FRINT64Z);
...
void test_frintx_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: frintx_z_p_z_m" << std::endl; return; }
...
void test_frintx_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: frintx_z_p_z_z" << std::endl; return; }
...
void test_frinti_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: frinti_z_p_z_m" << std::endl; return; }
...
void test_frinti_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: frinti_z_p_z_z" << std::endl; return; }
...
void test_frinta_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: frinta_z_p_z_m" << std::endl; return; }
...
void test_frinta_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: frinta_z_p_z_z" << std::endl; return; }
...
void test_frintn_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: frintn_z_p_z_m" << std::endl; return; }
...
void test_frintn_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: frintn_z_p_z_z" << std::endl; return; }
...
void test_frintz_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: frintz_z_p_z_m" << std::endl; return; }
...
void test_frintz_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: frintz_z_p_z_z" << std::endl; return; }
...
void test_frintm_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: frintm_z_p_z_m" << std::endl; return; }
...
void test_frintm_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: frintm_z_p_z_z" << std::endl; return; }
...
void test_frintp_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: frintp_z_p_z_m" << std::endl; return; }
...
void test_frintp_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: frintp_z_p_z_z" << std::endl; return; }
...
void test_frsqrte_z_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: frsqrte_z_z_" << std::endl; return; }
...
void test_frsqrts_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: frsqrts_z_zz_" << std::endl; return; }
...
void test_fscale_z_p_zz_() {
    uint32_t insn = 0x65098000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fscale_z_p_zz_" << std::endl; return; }
...
void test_fsqrt_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fsqrt_z_p_z_m" << std::endl; return; }
...
void test_fsqrt_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fsqrt_z_p_z_z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FSQRT);
...
void test_fsub_z_p_zs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fsub_z_p_zs_" << std::endl; return; }
...
void test_fsub_z_p_zz_() {
    uint32_t insn = 0x65018000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fsub_z_p_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FSUB);
...
void test_fsub_z_zz_() {
    uint32_t insn = 0x65000400u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fsub_z_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FSUB);
...
void test_fsubr_z_p_zs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fsubr_z_p_zs_" << std::endl; return; }
...
void test_fsubr_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: fsubr_z_p_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::FSUBR);
...
void test_ftmad_z_zzi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ftmad_z_zzi_" << std::endl; return; }
...
void test_ftsmul_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ftsmul_z_zz_" << std::endl; return; }
...
void test_ftssel_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ftssel_z_zz_" << std::endl; return; }
...
void test_histcnt_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: histcnt_z_p_zz_" << std::endl; return; }
...
void test_histseg_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: histseg_z_zz_" << std::endl; return; }
...
void test_incb_r_rs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: incb_r_rs_" << std::endl; return; }
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_incd_r_rs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: incd_r_rs_" << std::endl; return; }
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_inch_r_rs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: inch_r_rs_" << std::endl; return; }
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_incw_r_rs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: incw_r_rs_" << std::endl; return; }
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_incd_z_zs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: incd_z_zs_" << std::endl; return; }
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_inch_z_zs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: inch_z_zs_" << std::endl; return; }
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_incw_z_zs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: incw_z_zs_" << std::endl; return; }
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_incp_r_p_r_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: incp_r_p_r_" << std::endl; return; }
...
void test_incp_z_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: incp_z_p_z_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::INCP);
...
void test_index_z_ii_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: index_z_ii_" << std::endl; return; }
...
void test_index_z_ir_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: index_z_ir_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::INDEX);
...
void test_index_z_ri_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: index_z_ri_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::INDEX);
...
void test_index_z_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: index_z_rr_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::INDEX);
...
void test_insr_z_r_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: insr_z_r_" << std::endl; return; }
...
void test_insr_z_v_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: insr_z_v_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::INSR);
...
void test_lasta_r_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: lasta_r_p_z_" << std::endl; return; }
...
void test_lasta_v_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: lasta_v_p_z_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LASTA);
...
void test_lastb_r_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: lastb_r_p_z_" << std::endl; return; }
...
void test_lastb_v_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: lastb_v_p_z_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LASTB);
...
void test_lastp_r_p_p_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: lastp_r_p_p_" << std::endl; return; }
...
void test_ld1b_z_p_ai_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1b_z_p_ai_s" << std::endl; return; }
...
void test_ld1b_z_p_ai_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1b_z_p_ai_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1b_z_p_bi_u8() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1b_z_p_bi_u8" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1b_z_p_bi_u16() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1b_z_p_bi_u16" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1b_z_p_bi_u32() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1b_z_p_bi_u32" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1b_z_p_bi_u64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1b_z_p_bi_u64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1b_z_p_br_u8() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1b_z_p_br_u8" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1b_z_p_br_u16() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1b_z_p_br_u16" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1b_z_p_br_u32() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1b_z_p_br_u32" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1b_z_p_br_u64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1b_z_p_br_u64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1b_z_p_bz_d_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1b_z_p_bz_d_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1b_z_p_bz_s_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1b_z_p_bz_s_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1b_z_p_bz_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1b_z_p_bz_d_64_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1d_z_p_ai_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1d_z_p_ai_d" << std::endl; return; }
...
void test_ld1d_z_p_bi_u64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1d_z_p_bi_u64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1d_z_p_bi_u128() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1d_z_p_bi_u128" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1d_z_p_br_u64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1d_z_p_br_u64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1d_z_p_br_u128() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1d_z_p_br_u128" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1d_z_p_bz_d_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1d_z_p_bz_d_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1d_z_p_bz_d_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1d_z_p_bz_d_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1d_z_p_bz_d_64_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1d_z_p_bz_d_64_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1d_z_p_bz_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1d_z_p_bz_d_64_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1h_z_p_ai_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1h_z_p_ai_s" << std::endl; return; }
...
void test_ld1h_z_p_ai_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1h_z_p_ai_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1h_z_p_bi_u16() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1h_z_p_bi_u16" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1h_z_p_bi_u32() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1h_z_p_bi_u32" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1h_z_p_bi_u64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1h_z_p_bi_u64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1h_z_p_br_u16() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1h_z_p_br_u16" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1h_z_p_br_u32() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1h_z_p_br_u32" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1h_z_p_br_u64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1h_z_p_br_u64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1h_z_p_bz_s_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1h_z_p_bz_s_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1h_z_p_bz_d_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1h_z_p_bz_d_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1h_z_p_bz_d_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1h_z_p_bz_d_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1h_z_p_bz_s_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1h_z_p_bz_s_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1h_z_p_bz_d_64_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1h_z_p_bz_d_64_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1h_z_p_bz_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1h_z_p_bz_d_64_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1q_z_p_ar_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1q_z_p_ar_d_64_unscaled" << std::endl; return; }
...
void test_ld1rb_z_p_bi_u8() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1rb_z_p_bi_u8" << std::endl; return; }
...
void test_ld1rb_z_p_bi_u16() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1rb_z_p_bi_u16" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1RB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1rb_z_p_bi_u32() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1rb_z_p_bi_u32" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1RB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1rb_z_p_bi_u64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1rb_z_p_bi_u64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1RB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1rd_z_p_bi_u64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1rd_z_p_bi_u64" << std::endl; return; }
...
void test_ld1rh_z_p_bi_u16() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1rh_z_p_bi_u16" << std::endl; return; }
...
void test_ld1rh_z_p_bi_u32() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1rh_z_p_bi_u32" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1RH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1rh_z_p_bi_u64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1rh_z_p_bi_u64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1RH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1rob_z_p_bi_u8() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1rob_z_p_bi_u8" << std::endl; return; }
...
void test_ld1rob_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1rob_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1ROB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1rod_z_p_bi_u64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1rod_z_p_bi_u64" << std::endl; return; }
...
void test_ld1rod_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1rod_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1ROD);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1roh_z_p_bi_u16() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1roh_z_p_bi_u16" << std::endl; return; }
...
void test_ld1roh_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1roh_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1ROH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1row_z_p_bi_u32() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1row_z_p_bi_u32" << std::endl; return; }
...
void test_ld1row_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1row_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1ROW);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1rqb_z_p_bi_u8() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1rqb_z_p_bi_u8" << std::endl; return; }
...
void test_ld1rqb_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1rqb_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1RQB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1rqd_z_p_bi_u64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1rqd_z_p_bi_u64" << std::endl; return; }
...
void test_ld1rqd_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1rqd_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1RQD);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1rqh_z_p_bi_u16() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1rqh_z_p_bi_u16" << std::endl; return; }
...
void test_ld1rqh_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1rqh_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1RQH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1rqw_z_p_bi_u32() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1rqw_z_p_bi_u32" << std::endl; return; }
...
void test_ld1rqw_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1rqw_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1RQW);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1rsb_z_p_bi_s16() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1rsb_z_p_bi_s16" << std::endl; return; }
...
void test_ld1rsb_z_p_bi_s32() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1rsb_z_p_bi_s32" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1RSB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1rsb_z_p_bi_s64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1rsb_z_p_bi_s64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1RSB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1rsh_z_p_bi_s32() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1rsh_z_p_bi_s32" << std::endl; return; }
...
void test_ld1rsh_z_p_bi_s64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1rsh_z_p_bi_s64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1RSH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1rsw_z_p_bi_s64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1rsw_z_p_bi_s64" << std::endl; return; }
...
void test_ld1rw_z_p_bi_u32() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1rw_z_p_bi_u32" << std::endl; return; }
...
void test_ld1rw_z_p_bi_u64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1rw_z_p_bi_u64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1RW);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1sb_z_p_ai_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sb_z_p_ai_s" << std::endl; return; }
...
void test_ld1sb_z_p_ai_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sb_z_p_ai_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1SB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1sb_z_p_bi_s16() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sb_z_p_bi_s16" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1SB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1sb_z_p_bi_s32() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sb_z_p_bi_s32" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1SB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1sb_z_p_bi_s64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sb_z_p_bi_s64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1SB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1sb_z_p_br_s16() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sb_z_p_br_s16" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1SB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1sb_z_p_br_s32() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sb_z_p_br_s32" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1SB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1sb_z_p_br_s64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sb_z_p_br_s64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1SB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1sb_z_p_bz_d_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sb_z_p_bz_d_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1SB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1sb_z_p_bz_s_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sb_z_p_bz_s_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1SB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1sb_z_p_bz_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sb_z_p_bz_d_64_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1SB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1sh_z_p_ai_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sh_z_p_ai_s" << std::endl; return; }
...
void test_ld1sh_z_p_ai_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sh_z_p_ai_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1SH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1sh_z_p_bi_s32() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sh_z_p_bi_s32" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1SH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1sh_z_p_bi_s64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sh_z_p_bi_s64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1SH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1sh_z_p_br_s32() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sh_z_p_br_s32" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1SH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1sh_z_p_br_s64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sh_z_p_br_s64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1SH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1sh_z_p_bz_s_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sh_z_p_bz_s_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1SH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1sh_z_p_bz_d_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sh_z_p_bz_d_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1SH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1sh_z_p_bz_d_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sh_z_p_bz_d_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1SH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1sh_z_p_bz_s_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sh_z_p_bz_s_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1SH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1sh_z_p_bz_d_64_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sh_z_p_bz_d_64_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1SH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1sh_z_p_bz_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sh_z_p_bz_d_64_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1SH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1sw_z_p_ai_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sw_z_p_ai_d" << std::endl; return; }
...
void test_ld1sw_z_p_bi_s64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sw_z_p_bi_s64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1SW);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1sw_z_p_br_s64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sw_z_p_br_s64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1SW);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1sw_z_p_bz_d_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sw_z_p_bz_d_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1SW);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1sw_z_p_bz_d_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sw_z_p_bz_d_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1SW);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1sw_z_p_bz_d_64_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sw_z_p_bz_d_64_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1SW);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1sw_z_p_bz_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1sw_z_p_bz_d_64_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1SW);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1w_z_p_ai_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1w_z_p_ai_s" << std::endl; return; }
...
void test_ld1w_z_p_ai_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1w_z_p_ai_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1w_z_p_bi_u32() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1w_z_p_bi_u32" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1w_z_p_bi_u64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1w_z_p_bi_u64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1w_z_p_bi_u128() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1w_z_p_bi_u128" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1w_z_p_br_u32() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1w_z_p_br_u32" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1w_z_p_br_u64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1w_z_p_br_u64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1w_z_p_br_u128() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1w_z_p_br_u128" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1w_z_p_bz_s_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1w_z_p_bz_s_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1w_z_p_bz_d_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1w_z_p_bz_d_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1w_z_p_bz_d_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1w_z_p_bz_d_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1w_z_p_bz_s_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1w_z_p_bz_s_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1w_z_p_bz_d_64_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1w_z_p_bz_d_64_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld1w_z_p_bz_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld1w_z_p_bz_d_64_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld2b_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld2b_z_p_bi_contiguous" << std::endl; return; }
...
void test_ld2b_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld2b_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD2B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld2d_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld2d_z_p_bi_contiguous" << std::endl; return; }
...
void test_ld2d_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld2d_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD2D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld2h_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld2h_z_p_bi_contiguous" << std::endl; return; }
...
void test_ld2h_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld2h_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD2H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld2q_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld2q_z_p_bi_contiguous" << std::endl; return; }
...
void test_ld2q_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld2q_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD2Q);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld2w_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld2w_z_p_bi_contiguous" << std::endl; return; }
...
void test_ld2w_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld2w_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD2W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld3b_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld3b_z_p_bi_contiguous" << std::endl; return; }
...
void test_ld3b_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld3b_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD3B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld3d_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld3d_z_p_bi_contiguous" << std::endl; return; }
...
void test_ld3d_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld3d_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD3D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld3h_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld3h_z_p_bi_contiguous" << std::endl; return; }
...
void test_ld3h_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld3h_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD3H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld3q_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld3q_z_p_bi_contiguous" << std::endl; return; }
...
void test_ld3q_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld3q_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD3Q);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld3w_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld3w_z_p_bi_contiguous" << std::endl; return; }
...
void test_ld3w_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld3w_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD3W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld4b_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld4b_z_p_bi_contiguous" << std::endl; return; }
...
void test_ld4b_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld4b_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD4B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld4d_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld4d_z_p_bi_contiguous" << std::endl; return; }
...
void test_ld4d_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld4d_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD4D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld4h_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld4h_z_p_bi_contiguous" << std::endl; return; }
...
void test_ld4h_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld4h_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD4H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld4q_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld4q_z_p_bi_contiguous" << std::endl; return; }
...
void test_ld4q_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld4q_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD4Q);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ld4w_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld4w_z_p_bi_contiguous" << std::endl; return; }
...
void test_ld4w_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ld4w_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LD4W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1b_z_p_ai_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1b_z_p_ai_s" << std::endl; return; }
...
void test_ldff1b_z_p_ai_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1b_z_p_ai_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1b_z_p_br_u8() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1b_z_p_br_u8" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1b_z_p_br_u16() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1b_z_p_br_u16" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1b_z_p_br_u32() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1b_z_p_br_u32" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1b_z_p_br_u64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1b_z_p_br_u64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1b_z_p_bz_d_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1b_z_p_bz_d_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1b_z_p_bz_s_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1b_z_p_bz_s_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1b_z_p_bz_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1b_z_p_bz_d_64_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1d_z_p_ai_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1d_z_p_ai_d" << std::endl; return; }
...
void test_ldff1d_z_p_br_u64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1d_z_p_br_u64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1d_z_p_bz_d_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1d_z_p_bz_d_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1d_z_p_bz_d_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1d_z_p_bz_d_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1d_z_p_bz_d_64_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1d_z_p_bz_d_64_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1d_z_p_bz_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1d_z_p_bz_d_64_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1h_z_p_ai_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1h_z_p_ai_s" << std::endl; return; }
...
void test_ldff1h_z_p_ai_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1h_z_p_ai_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1h_z_p_br_u16() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1h_z_p_br_u16" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1h_z_p_br_u32() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1h_z_p_br_u32" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1h_z_p_br_u64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1h_z_p_br_u64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1h_z_p_bz_s_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1h_z_p_bz_s_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1h_z_p_bz_d_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1h_z_p_bz_d_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1h_z_p_bz_d_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1h_z_p_bz_d_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1h_z_p_bz_s_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1h_z_p_bz_s_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1h_z_p_bz_d_64_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1h_z_p_bz_d_64_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1h_z_p_bz_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1h_z_p_bz_d_64_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1sb_z_p_ai_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1sb_z_p_ai_s" << std::endl; return; }
...
void test_ldff1sb_z_p_ai_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1sb_z_p_ai_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1SB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1sb_z_p_br_s16() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1sb_z_p_br_s16" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1SB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1sb_z_p_br_s32() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1sb_z_p_br_s32" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1SB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1sb_z_p_br_s64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1sb_z_p_br_s64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1SB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1sb_z_p_bz_d_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1sb_z_p_bz_d_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1SB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1sb_z_p_bz_s_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1sb_z_p_bz_s_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1SB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1sb_z_p_bz_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1sb_z_p_bz_d_64_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1SB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1sh_z_p_ai_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1sh_z_p_ai_s" << std::endl; return; }
...
void test_ldff1sh_z_p_ai_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1sh_z_p_ai_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1SH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1sh_z_p_br_s32() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1sh_z_p_br_s32" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1SH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1sh_z_p_br_s64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1sh_z_p_br_s64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1SH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1sh_z_p_bz_s_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1sh_z_p_bz_s_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1SH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1sh_z_p_bz_d_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1sh_z_p_bz_d_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1SH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1sh_z_p_bz_d_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1sh_z_p_bz_d_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1SH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1sh_z_p_bz_s_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1sh_z_p_bz_s_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1SH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1sh_z_p_bz_d_64_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1sh_z_p_bz_d_64_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1SH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1sh_z_p_bz_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1sh_z_p_bz_d_64_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1SH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1sw_z_p_ai_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1sw_z_p_ai_d" << std::endl; return; }
...
void test_ldff1sw_z_p_br_s64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1sw_z_p_br_s64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1SW);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1sw_z_p_bz_d_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1sw_z_p_bz_d_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1SW);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1sw_z_p_bz_d_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1sw_z_p_bz_d_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1SW);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1sw_z_p_bz_d_64_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1sw_z_p_bz_d_64_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1SW);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1sw_z_p_bz_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1sw_z_p_bz_d_64_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1SW);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1w_z_p_ai_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1w_z_p_ai_s" << std::endl; return; }
...
void test_ldff1w_z_p_ai_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1w_z_p_ai_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1w_z_p_br_u32() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1w_z_p_br_u32" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1w_z_p_br_u64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1w_z_p_br_u64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1w_z_p_bz_s_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1w_z_p_bz_s_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1w_z_p_bz_d_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1w_z_p_bz_d_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1w_z_p_bz_d_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1w_z_p_bz_d_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1w_z_p_bz_s_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1w_z_p_bz_s_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1w_z_p_bz_d_64_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1w_z_p_bz_d_64_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldff1w_z_p_bz_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldff1w_z_p_bz_d_64_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDFF1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldnf1b_z_p_bi_u8() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnf1b_z_p_bi_u8" << std::endl; return; }
...
void test_ldnf1b_z_p_bi_u16() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnf1b_z_p_bi_u16" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDNF1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldnf1b_z_p_bi_u32() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnf1b_z_p_bi_u32" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDNF1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldnf1b_z_p_bi_u64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnf1b_z_p_bi_u64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDNF1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldnf1d_z_p_bi_u64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnf1d_z_p_bi_u64" << std::endl; return; }
...
void test_ldnf1h_z_p_bi_u16() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnf1h_z_p_bi_u16" << std::endl; return; }
...
void test_ldnf1h_z_p_bi_u32() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnf1h_z_p_bi_u32" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDNF1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldnf1h_z_p_bi_u64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnf1h_z_p_bi_u64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDNF1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldnf1sb_z_p_bi_s16() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnf1sb_z_p_bi_s16" << std::endl; return; }
...
void test_ldnf1sb_z_p_bi_s32() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnf1sb_z_p_bi_s32" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDNF1SB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldnf1sb_z_p_bi_s64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnf1sb_z_p_bi_s64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDNF1SB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldnf1sh_z_p_bi_s32() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnf1sh_z_p_bi_s32" << std::endl; return; }
...
void test_ldnf1sh_z_p_bi_s64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnf1sh_z_p_bi_s64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDNF1SH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldnf1sw_z_p_bi_s64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnf1sw_z_p_bi_s64" << std::endl; return; }
...
void test_ldnf1w_z_p_bi_u32() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnf1w_z_p_bi_u32" << std::endl; return; }
...
void test_ldnf1w_z_p_bi_u64() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnf1w_z_p_bi_u64" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDNF1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldnt1b_z_p_ar_s_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnt1b_z_p_ar_s_x32_unscaled" << std::endl; return; }
...
void test_ldnt1b_z_p_ar_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnt1b_z_p_ar_d_64_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDNT1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldnt1b_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnt1b_z_p_bi_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDNT1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldnt1b_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnt1b_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDNT1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldnt1d_z_p_ar_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnt1d_z_p_ar_d_64_unscaled" << std::endl; return; }
...
void test_ldnt1d_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnt1d_z_p_bi_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDNT1D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldnt1d_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnt1d_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDNT1D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldnt1h_z_p_ar_s_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnt1h_z_p_ar_s_x32_unscaled" << std::endl; return; }
...
void test_ldnt1h_z_p_ar_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnt1h_z_p_ar_d_64_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDNT1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldnt1h_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnt1h_z_p_bi_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDNT1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldnt1h_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnt1h_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDNT1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldnt1sb_z_p_ar_s_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnt1sb_z_p_ar_s_x32_unscaled" << std::endl; return; }
...
void test_ldnt1sb_z_p_ar_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnt1sb_z_p_ar_d_64_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDNT1SB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldnt1sh_z_p_ar_s_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnt1sh_z_p_ar_s_x32_unscaled" << std::endl; return; }
...
void test_ldnt1sh_z_p_ar_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnt1sh_z_p_ar_d_64_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDNT1SH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldnt1sw_z_p_ar_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnt1sw_z_p_ar_d_64_unscaled" << std::endl; return; }
...
void test_ldnt1w_z_p_ar_s_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnt1w_z_p_ar_s_x32_unscaled" << std::endl; return; }
...
void test_ldnt1w_z_p_ar_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnt1w_z_p_ar_d_64_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDNT1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldnt1w_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnt1w_z_p_bi_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDNT1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldnt1w_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldnt1w_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDNT1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ldr_p_bi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldr_p_bi_" << std::endl; return; }
...
void test_ldr_z_bi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ldr_z_bi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LDR);
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Memory);
...
void test_lsl_z_p_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: lsl_z_p_zi_" << std::endl; return; }
...
void test_lsl_z_p_zw_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: lsl_z_p_zw_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LSL);
...
void test_lsl_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: lsl_z_p_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LSL);
...
void test_lsl_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: lsl_z_zi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LSL);
...
void test_lsl_z_zw_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: lsl_z_zw_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LSL);
...
void test_lslr_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: lslr_z_p_zz_" << std::endl; return; }
...
void test_lsr_z_p_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: lsr_z_p_zi_" << std::endl; return; }
...
void test_lsr_z_p_zw_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: lsr_z_p_zw_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LSR);
...
void test_lsr_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: lsr_z_p_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LSR);
...
void test_lsr_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: lsr_z_zi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LSR);
...
void test_lsr_z_zw_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: lsr_z_zw_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LSR);
...
void test_lsrr_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: lsrr_z_p_zz_" << std::endl; return; }
...
void test_luti2_z_zz_8() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: luti2_z_zz_8" << std::endl; return; }
...
void test_luti2_z_zz_16() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: luti2_z_zz_16" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LUTI2);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::RegisterList);
...
void test_luti4_z_zz_8() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: luti4_z_zz_8" << std::endl; return; }
...
void test_luti4_z_zz_2x16() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: luti4_z_zz_2x16" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LUTI4);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::RegisterList);
...
void test_luti4_z_zz_1x16() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: luti4_z_zz_1x16" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LUTI4);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::RegisterList);
...
void test_luti6_z_zzz_16() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: luti6_z_zzz_16" << std::endl; return; }
...
void test_luti6_z_zzz_8() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: luti6_z_zzz_8" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::LUTI6);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::RegisterList);
...
void test_mad_z_p_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mad_z_p_zzz_" << std::endl; return; }
...
void test_madpt_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: madpt_z_zzz_" << std::endl; return; }
...
void test_match_p_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: match_p_p_zz_" << std::endl; return; }
...
void test_mla_z_p_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mla_z_p_zzz_" << std::endl; return; }
...
void test_mla_z_zzzi_h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mla_z_zzzi_h" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::MLA);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_mla_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mla_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::MLA);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_mla_z_zzzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mla_z_zzzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::MLA);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_mlapt_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mlapt_z_zzz_" << std::endl; return; }
...
void test_mls_z_p_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mls_z_p_zzz_" << std::endl; return; }
...
void test_mls_z_zzzi_h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mls_z_zzzi_h" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::MLS);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_mls_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mls_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::MLS);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_mls_z_zzzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mls_z_zzzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::MLS);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_movz_p_p_p__and_p_p_pp_z() {
    uint32_t insn = 0x25004000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: movz_p_p_p__and_p_p_pp_z" << std::endl; return; }
...
void test_mov_z_o_i__cpy_z_o_i_() {
    uint32_t insn = 0x05100000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mov_z_o_i__cpy_z_o_i_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CPY);
...
void test_mov_z_p_i__cpy_z_p_i_() {
    uint32_t insn = 0x05104000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mov_z_p_i__cpy_z_p_i_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CPY);
...
void test_mov_z_p_r__cpy_z_p_r_() {
    uint32_t insn = 0x0528A000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mov_z_p_r__cpy_z_p_r_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CPY);
...
void test_mov_z_p_v__cpy_z_p_v_() {
    uint32_t insn = 0x05208000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mov_z_p_v__cpy_z_p_v_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::CPY);
...
void test_mov_z_i__dup_z_i_() {
    uint32_t insn = 0x2538C000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mov_z_i__dup_z_i_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::DUP);
...
void test_mov_z_r__dup_z_r_() {
    uint32_t insn = 0x05203800u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mov_z_r__dup_z_r_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::DUP);
...
void test_mov_z_v__dup_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mov_z_v__dup_z_zi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::DUP);
...
void test_mov_z_zi__dup_z_zi_() {
    uint32_t insn = 0x05202000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mov_z_zi__dup_z_zi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::DUP);
...
void test_mov_z_m__dupm_z_i_() {
    uint32_t insn = 0x05C00000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mov_z_m__dupm_z_i_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::DUPM);
...
void test_mov_p_p__orr_p_p_pp_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mov_p_p__orr_p_p_pp_z" << std::endl; return; }
...
void test_mov_z_z__orr_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mov_z_z__orr_z_zz_" << std::endl; return; }
...
void test_movm_p_p_p__sel_p_p_pp_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: movm_p_p_p__sel_p_p_pp_" << std::endl; return; }
...
void test_mov_z_p_z__sel_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mov_z_p_z__sel_z_p_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SEL);
...
void test_movprfx_z_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: movprfx_z_p_z_" << std::endl; return; }
...
void test_movprfx_z_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: movprfx_z_z_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::MOVPRFX);
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_movzs_p_p_p__ands_p_p_pp_z() {
    uint32_t insn = 0x25404000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: movzs_p_p_p__ands_p_p_pp_z" << std::endl; return; }
...
void test_movs_p_p__orrs_p_p_pp_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: movs_p_p__orrs_p_p_pp_z" << std::endl; return; }
...
void test_msb_z_p_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: msb_z_p_zzz_" << std::endl; return; }
...
void test_mul_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mul_z_p_zz_" << std::endl; return; }
...
void test_mul_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mul_z_zi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::MUL);
...
void test_mul_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mul_z_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::MUL);
...
void test_mul_z_zzi_h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mul_z_zzi_h" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::MUL);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_mul_z_zzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mul_z_zzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::MUL);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_mul_z_zzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mul_z_zzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::MUL);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_nand_p_p_pp_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: nand_p_p_pp_z" << std::endl; return; }
...
void test_nands_p_p_pp_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: nands_p_p_pp_z" << std::endl; return; }
...
void test_nbsl_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: nbsl_z_zzz_" << std::endl; return; }
...
void test_neg_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: neg_z_p_z_m" << std::endl; return; }
...
void test_neg_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: neg_z_p_z_z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::NEG);
...
void test_nmatch_p_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: nmatch_p_p_zz_" << std::endl; return; }
...
void test_nor_p_p_pp_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: nor_p_p_pp_z" << std::endl; return; }
...
void test_nors_p_p_pp_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: nors_p_p_pp_z" << std::endl; return; }
...
void test_not_p_p_p_z_eor_p_p_pp_z() {
    uint32_t insn = 0x25004200u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: not_p_p_p_z_eor_p_p_pp_z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::EOR);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_not_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: not_z_p_z_m" << std::endl; return; }
...
void test_not_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: not_z_p_z_z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::NOT);
...
void test_nots_p_p_p_z_eors_p_p_pp_z() {
    uint32_t insn = 0x25404200u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: nots_p_p_p_z_eors_p_p_pp_z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::EORS);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_orn_z_zi__orr_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: orn_z_zi__orr_z_zi_" << std::endl; return; }
...
void test_orn_p_p_pp_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: orn_p_p_pp_z" << std::endl; return; }
...
void test_orns_p_p_pp_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: orns_p_p_pp_z" << std::endl; return; }
...
void test_orqv_z_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: orqv_z_p_z_" << std::endl; return; }
...
void test_orr_p_p_pp_z() {
    uint32_t insn = 0x25804000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: orr_p_p_pp_z" << std::endl; return; }
...
void test_orr_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: orr_z_p_zz_" << std::endl; return; }
...
void test_orr_z_zi_() {
    uint32_t insn = 0x05000000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: orr_z_zi_" << std::endl; return; }
...
void test_orr_z_zz_() {
    uint32_t insn = 0x04603000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: orr_z_zz_" << std::endl; return; }
...
void test_orrs_p_p_pp_z() {
    uint32_t insn = 0x25C04000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: orrs_p_p_pp_z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ORRS);
    assert(result->operands.size() >= 4);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_orv_r_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: orv_r_p_z_" << std::endl; return; }
...
void test_pext_pn_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: pext_pn_rr_" << std::endl; return; }
...
void test_pext_pp_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: pext_pp_rr_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PEXT);
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_pfalse_p_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: pfalse_p_" << std::endl; return; }
...
void test_pfirst_p_p_p_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: pfirst_p_p_p_" << std::endl; return; }
...
void test_pmlal_mz_zzzw_1x2() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: pmlal_mz_zzzw_1x2" << std::endl; return; }
...
void test_pmov_p_zi_b() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: pmov_p_zi_b" << std::endl; return; }
...
void test_pmov_p_zi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: pmov_p_zi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PMOV);
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::RegisterList);
...
void test_pmov_p_zi_h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: pmov_p_zi_h" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PMOV);
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::RegisterList);
...
void test_pmov_p_zi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: pmov_p_zi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PMOV);
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::RegisterList);
...
void test_pmov_z_pi_b() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: pmov_z_pi_b" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PMOV);
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_pmov_z_pi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: pmov_z_pi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PMOV);
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_pmov_z_pi_h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: pmov_z_pi_h" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PMOV);
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_pmov_z_pi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: pmov_z_pi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PMOV);
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_pmul_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: pmul_z_zz_" << std::endl; return; }
...
void test_pmull_mz_zzw_1x2() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: pmull_mz_zzw_1x2" << std::endl; return; }
...
void test_pmullb_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: pmullb_z_zz_" << std::endl; return; }
...
void test_pmullb_z_zz_q() {
    uint32_t insn = 0x45006800u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: pmullb_z_zz_q" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PMULLB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_pmullt_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: pmullt_z_zz_" << std::endl; return; }
...
void test_pmullt_z_zz_q() {
    uint32_t insn = 0x45006C00u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: pmullt_z_zz_q" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PMULLT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_pnext_p_p_p_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: pnext_p_p_p_" << std::endl; return; }
...
void test_prfb_i_p_ai_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: prfb_i_p_ai_s" << std::endl; return; }
...
void test_prfb_i_p_ai_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: prfb_i_p_ai_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PRFB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_prfb_i_p_bi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: prfb_i_p_bi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PRFB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_prfb_i_p_br_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: prfb_i_p_br_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PRFB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_prfb_i_p_bz_s_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: prfb_i_p_bz_s_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PRFB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_prfb_i_p_bz_d_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: prfb_i_p_bz_d_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PRFB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_prfb_i_p_bz_d_64_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: prfb_i_p_bz_d_64_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PRFB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_prfd_i_p_ai_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: prfd_i_p_ai_s" << std::endl; return; }
...
void test_prfd_i_p_ai_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: prfd_i_p_ai_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PRFD);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_prfd_i_p_bi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: prfd_i_p_bi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PRFD);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_prfd_i_p_br_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: prfd_i_p_br_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PRFD);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_prfd_i_p_bz_s_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: prfd_i_p_bz_s_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PRFD);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_prfd_i_p_bz_d_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: prfd_i_p_bz_d_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PRFD);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_prfd_i_p_bz_d_64_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: prfd_i_p_bz_d_64_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PRFD);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_prfh_i_p_ai_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: prfh_i_p_ai_s" << std::endl; return; }
...
void test_prfh_i_p_ai_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: prfh_i_p_ai_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PRFH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_prfh_i_p_bi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: prfh_i_p_bi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PRFH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_prfh_i_p_br_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: prfh_i_p_br_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PRFH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_prfh_i_p_bz_s_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: prfh_i_p_bz_s_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PRFH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_prfh_i_p_bz_d_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: prfh_i_p_bz_d_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PRFH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_prfh_i_p_bz_d_64_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: prfh_i_p_bz_d_64_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PRFH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_prfw_i_p_ai_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: prfw_i_p_ai_s" << std::endl; return; }
...
void test_prfw_i_p_ai_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: prfw_i_p_ai_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PRFW);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_prfw_i_p_bi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: prfw_i_p_bi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PRFW);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_prfw_i_p_br_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: prfw_i_p_br_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PRFW);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_prfw_i_p_bz_s_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: prfw_i_p_bz_s_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PRFW);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_prfw_i_p_bz_d_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: prfw_i_p_bz_d_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PRFW);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_prfw_i_p_bz_d_64_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: prfw_i_p_bz_d_64_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PRFW);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_psel_p_ppi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: psel_p_ppi_" << std::endl; return; }
...
void test_ptest__p_p_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ptest__p_p_" << std::endl; return; }
...
void test_ptrue_p_s_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ptrue_p_s_" << std::endl; return; }
...
void test_ptrue_pn_i_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ptrue_pn_i_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::PTRUE);
...
void test_ptrues_p_s_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ptrues_p_s_" << std::endl; return; }
...
void test_punpkhi_p_p_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: punpkhi_p_p_" << std::endl; return; }
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_punpklo_p_p_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: punpklo_p_p_" << std::endl; return; }
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_raddhnb_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: raddhnb_z_zz_" << std::endl; return; }
...
void test_raddhnt_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: raddhnt_z_zz_" << std::endl; return; }
...
void test_rax1_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: rax1_z_zz_" << std::endl; return; }
...
void test_rbit_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: rbit_z_p_z_m" << std::endl; return; }
...
void test_rbit_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: rbit_z_p_z_z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::RBIT);
...
void test_rdffr_p_f_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: rdffr_p_f_" << std::endl; return; }
...
void test_rdffr_p_p_f_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: rdffr_p_p_f_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::RDFFR);
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_rdffrs_p_p_f_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: rdffrs_p_p_f_" << std::endl; return; }
...
void test_rdsvl_r_i_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: rdsvl_r_i_" << std::endl; return; }
...
void test_rdvl_r_i_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: rdvl_r_i_" << std::endl; return; }
...
void test_rev_p_p_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: rev_p_p_" << std::endl; return; }
...
void test_rev_z_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: rev_z_z_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::REV);
...
void test_revb_z_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: revb_z_z_m" << std::endl; return; }
...
void test_revb_z_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: revb_z_z_z" << std::endl; return; }
...
void test_revh_z_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: revh_z_z_m" << std::endl; return; }
...
void test_revh_z_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: revh_z_z_z" << std::endl; return; }
...
void test_revw_z_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: revw_z_z_m" << std::endl; return; }
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
    assert(result->operands[2].type == OperandType::Register);
...
void test_revw_z_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: revw_z_z_z" << std::endl; return; }
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
    assert(result->operands[2].type == OperandType::Register);
...
void test_revd_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: revd_z_p_z_m" << std::endl; return; }
...
void test_revd_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: revd_z_p_z_z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::REVD);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_rshrnb_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: rshrnb_z_zi_" << std::endl; return; }
...
void test_rshrnt_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: rshrnt_z_zi_" << std::endl; return; }
...
void test_rsubhnb_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: rsubhnb_z_zz_" << std::endl; return; }
...
void test_rsubhnt_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: rsubhnt_z_zz_" << std::endl; return; }
...
void test_saba_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: saba_z_zzz_" << std::endl; return; }
...
void test_sabal_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sabal_z_zz_" << std::endl; return; }
...
void test_sabalb_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sabalb_z_zzz_" << std::endl; return; }
...
void test_sabalt_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sabalt_z_zzz_" << std::endl; return; }
...
void test_sabd_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sabd_z_p_zz_" << std::endl; return; }
...
void test_sabdlb_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sabdlb_z_zz_" << std::endl; return; }
...
void test_sabdlt_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sabdlt_z_zz_" << std::endl; return; }
...
void test_sadalp_z_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sadalp_z_p_z_" << std::endl; return; }
...
void test_saddlb_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: saddlb_z_zz_" << std::endl; return; }
...
void test_saddlbt_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: saddlbt_z_zz_" << std::endl; return; }
...
void test_saddlt_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: saddlt_z_zz_" << std::endl; return; }
...
void test_saddv_r_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: saddv_r_p_z_" << std::endl; return; }
...
void test_saddwb_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: saddwb_z_zz_" << std::endl; return; }
...
void test_saddwt_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: saddwt_z_zz_" << std::endl; return; }
...
void test_sbclb_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sbclb_z_zzz_" << std::endl; return; }
...
void test_sbclt_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sbclt_z_zzz_" << std::endl; return; }
...
void test_sclamp_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sclamp_z_zz_" << std::endl; return; }
...
void test_scvtf_z_p_z_h2fp16() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: scvtf_z_p_z_h2fp16" << std::endl; return; }
...
void test_scvtf_z_p_z_h2fp16z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: scvtf_z_p_z_h2fp16z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SCVTF);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_scvtf_z_p_z_w2fp16() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: scvtf_z_p_z_w2fp16" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SCVTF);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_scvtf_z_p_z_w2fp16z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: scvtf_z_p_z_w2fp16z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SCVTF);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_scvtf_z_p_z_w2s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: scvtf_z_p_z_w2s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SCVTF);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_scvtf_z_p_z_w2sz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: scvtf_z_p_z_w2sz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SCVTF);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_scvtf_z_p_z_w2d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: scvtf_z_p_z_w2d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SCVTF);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_scvtf_z_p_z_w2dz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: scvtf_z_p_z_w2dz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SCVTF);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_scvtf_z_p_z_x2fp16() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: scvtf_z_p_z_x2fp16" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SCVTF);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_scvtf_z_p_z_x2fp16z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: scvtf_z_p_z_x2fp16z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SCVTF);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_scvtf_z_p_z_x2s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: scvtf_z_p_z_x2s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SCVTF);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_scvtf_z_p_z_x2sz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: scvtf_z_p_z_x2sz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SCVTF);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_scvtf_z_p_z_x2d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: scvtf_z_p_z_x2d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SCVTF);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_scvtf_z_p_z_x2dz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: scvtf_z_p_z_x2dz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SCVTF);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_scvtf_z_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: scvtf_z_z_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SCVTF);
...
void test_scvtflt_z_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: scvtflt_z_z_" << std::endl; return; }
...
void test_sdiv_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sdiv_z_p_zz_" << std::endl; return; }
...
void test_sdivr_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sdivr_z_p_zz_" << std::endl; return; }
...
void test_sdot_z16_zzz_h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sdot_z16_zzz_h" << std::endl; return; }
...
void test_sdot_z32_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sdot_z32_zzz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SDOT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sdot_z16_zzzi_h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sdot_z16_zzzi_h" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SDOT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sdot_z32_zzzi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sdot_z32_zzzi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SDOT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sdot_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sdot_z_zzz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SDOT);
...
void test_sdot_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sdot_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SDOT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sdot_z_zzzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sdot_z_zzzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SDOT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sel_p_p_pp_() {
    uint32_t insn = 0x25004210u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sel_p_p_pp_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SEL);
    assert(result->operands.size() >= 4);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sel_z_p_zz_() {
    uint32_t insn = 0x0520C000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sel_z_p_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SEL);
...
void test_setffr_f_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: setffr_f_" << std::endl; return; }
...
void test_shadd_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: shadd_z_p_zz_" << std::endl; return; }
...
void test_shrnb_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: shrnb_z_zi_" << std::endl; return; }
...
void test_shrnt_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: shrnt_z_zi_" << std::endl; return; }
...
void test_shsub_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: shsub_z_p_zz_" << std::endl; return; }
...
void test_shsubr_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: shsubr_z_p_zz_" << std::endl; return; }
...
void test_sli_z_zzi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sli_z_zzi_" << std::endl; return; }
...
void test_sm4e_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sm4e_z_zz_" << std::endl; return; }
...
void test_sm4ekey_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sm4ekey_z_zz_" << std::endl; return; }
...
void test_smax_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smax_z_p_zz_" << std::endl; return; }
...
void test_smax_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smax_z_zi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SMAX);
...
void test_smaxp_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smaxp_z_p_zz_" << std::endl; return; }
...
void test_smaxqv_z_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smaxqv_z_p_z_" << std::endl; return; }
...
void test_smaxv_r_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smaxv_r_p_z_" << std::endl; return; }
...
void test_smin_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smin_z_p_zz_" << std::endl; return; }
...
void test_smin_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smin_z_zi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SMIN);
...
void test_sminp_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sminp_z_p_zz_" << std::endl; return; }
...
void test_sminqv_z_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sminqv_z_p_z_" << std::endl; return; }
...
void test_sminv_r_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sminv_r_p_z_" << std::endl; return; }
...
void test_smlalb_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smlalb_z_zzz_" << std::endl; return; }
...
void test_smlalb_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smlalb_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SMLALB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_smlalb_z_zzzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smlalb_z_zzzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SMLALB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_smlalt_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smlalt_z_zzz_" << std::endl; return; }
...
void test_smlalt_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smlalt_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SMLALT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_smlalt_z_zzzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smlalt_z_zzzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SMLALT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_smlslb_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smlslb_z_zzz_" << std::endl; return; }
...
void test_smlslb_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smlslb_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SMLSLB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_smlslb_z_zzzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smlslb_z_zzzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SMLSLB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_smlslt_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smlslt_z_zzz_" << std::endl; return; }
...
void test_smlslt_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smlslt_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SMLSLT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_smlslt_z_zzzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smlslt_z_zzzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SMLSLT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_smmla_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smmla_z_zzz_" << std::endl; return; }
...
void test_smulh_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smulh_z_p_zz_" << std::endl; return; }
...
void test_smulh_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smulh_z_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SMULH);
...
void test_smullb_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smullb_z_zz_" << std::endl; return; }
...
void test_smullb_z_zzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smullb_z_zzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SMULLB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_smullb_z_zzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smullb_z_zzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SMULLB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_smullt_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smullt_z_zz_" << std::endl; return; }
...
void test_smullt_z_zzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smullt_z_zzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SMULLT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_smullt_z_zzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smullt_z_zzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SMULLT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_splice_z_p_zz_con() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: splice_z_p_zz_con" << std::endl; return; }
...
void test_splice_z_p_zz_des() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: splice_z_p_zz_des" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SPLICE);
...
void test_sqabs_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqabs_z_p_z_m" << std::endl; return; }
...
void test_sqabs_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqabs_z_p_z_z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQABS);
...
void test_sqadd_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqadd_z_p_zz_" << std::endl; return; }
...
void test_sqadd_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqadd_z_zi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQADD);
...
void test_sqadd_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqadd_z_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQADD);
...
void test_sqcadd_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqcadd_z_zz_" << std::endl; return; }
...
void test_sqcvtn_z_mz2_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqcvtn_z_mz2_" << std::endl; return; }
...
void test_sqcvtun_z_mz2_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqcvtun_z_mz2_" << std::endl; return; }
...
void test_sqdecb_r_rs_sx() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdecb_r_rs_sx" << std::endl; return; }
...
void test_sqdecb_r_rs_x() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdecb_r_rs_x" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQDECB);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_sqdecd_r_rs_sx() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdecd_r_rs_sx" << std::endl; return; }
...
void test_sqdecd_r_rs_x() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdecd_r_rs_x" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQDECD);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_sqdecd_z_zs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdecd_z_zs_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQDECD);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_sqdech_r_rs_sx() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdech_r_rs_sx" << std::endl; return; }
...
void test_sqdech_r_rs_x() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdech_r_rs_x" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQDECH);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_sqdech_z_zs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdech_z_zs_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQDECH);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_sqdecp_r_p_r_sx() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdecp_r_p_r_sx" << std::endl; return; }
...
void test_sqdecp_r_p_r_x() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdecp_r_p_r_x" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQDECP);
...
void test_sqdecp_z_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdecp_z_p_z_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQDECP);
...
void test_sqdecw_r_rs_sx() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdecw_r_rs_sx" << std::endl; return; }
...
void test_sqdecw_r_rs_x() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdecw_r_rs_x" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQDECW);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_sqdecw_z_zs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdecw_z_zs_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQDECW);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_sqdmlalb_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdmlalb_z_zzz_" << std::endl; return; }
...
void test_sqdmlalb_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdmlalb_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQDMLALB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sqdmlalb_z_zzzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdmlalb_z_zzzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQDMLALB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sqdmlalbt_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdmlalbt_z_zzz_" << std::endl; return; }
...
void test_sqdmlalt_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdmlalt_z_zzz_" << std::endl; return; }
...
void test_sqdmlalt_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdmlalt_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQDMLALT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sqdmlalt_z_zzzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdmlalt_z_zzzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQDMLALT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sqdmlslb_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdmlslb_z_zzz_" << std::endl; return; }
...
void test_sqdmlslb_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdmlslb_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQDMLSLB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sqdmlslb_z_zzzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdmlslb_z_zzzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQDMLSLB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sqdmlslbt_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdmlslbt_z_zzz_" << std::endl; return; }
...
void test_sqdmlslt_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdmlslt_z_zzz_" << std::endl; return; }
...
void test_sqdmlslt_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdmlslt_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQDMLSLT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sqdmlslt_z_zzzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdmlslt_z_zzzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQDMLSLT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sqdmulh_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdmulh_z_zz_" << std::endl; return; }
...
void test_sqdmulh_z_zzi_h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdmulh_z_zzi_h" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQDMULH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sqdmulh_z_zzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdmulh_z_zzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQDMULH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sqdmulh_z_zzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdmulh_z_zzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQDMULH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sqdmullb_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdmullb_z_zz_" << std::endl; return; }
...
void test_sqdmullb_z_zzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdmullb_z_zzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQDMULLB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sqdmullb_z_zzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdmullb_z_zzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQDMULLB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sqdmullt_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdmullt_z_zz_" << std::endl; return; }
...
void test_sqdmullt_z_zzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdmullt_z_zzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQDMULLT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sqdmullt_z_zzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqdmullt_z_zzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQDMULLT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sqincb_r_rs_sx() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqincb_r_rs_sx" << std::endl; return; }
...
void test_sqincb_r_rs_x() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqincb_r_rs_x" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQINCB);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_sqincd_r_rs_sx() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqincd_r_rs_sx" << std::endl; return; }
...
void test_sqincd_r_rs_x() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqincd_r_rs_x" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQINCD);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_sqincd_z_zs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqincd_z_zs_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQINCD);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_sqinch_r_rs_sx() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqinch_r_rs_sx" << std::endl; return; }
...
void test_sqinch_r_rs_x() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqinch_r_rs_x" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQINCH);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_sqinch_z_zs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqinch_z_zs_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQINCH);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_sqincp_r_p_r_sx() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqincp_r_p_r_sx" << std::endl; return; }
...
void test_sqincp_r_p_r_x() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqincp_r_p_r_x" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQINCP);
...
void test_sqincp_z_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqincp_z_p_z_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQINCP);
...
void test_sqincw_r_rs_sx() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqincw_r_rs_sx" << std::endl; return; }
...
void test_sqincw_r_rs_x() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqincw_r_rs_x" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQINCW);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_sqincw_z_zs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqincw_z_zs_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQINCW);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_sqneg_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqneg_z_p_z_m" << std::endl; return; }
...
void test_sqneg_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqneg_z_p_z_z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQNEG);
...
void test_sqrdcmlah_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqrdcmlah_z_zzz_" << std::endl; return; }
...
void test_sqrdcmlah_z_zzzi_h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqrdcmlah_z_zzzi_h" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQRDCMLAH);
...
void test_sqrdcmlah_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqrdcmlah_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQRDCMLAH);
...
void test_sqrdmlah_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqrdmlah_z_zzz_" << std::endl; return; }
...
void test_sqrdmlah_z_zzzi_h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqrdmlah_z_zzzi_h" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQRDMLAH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sqrdmlah_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqrdmlah_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQRDMLAH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sqrdmlah_z_zzzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqrdmlah_z_zzzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQRDMLAH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sqrdmlsh_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqrdmlsh_z_zzz_" << std::endl; return; }
...
void test_sqrdmlsh_z_zzzi_h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqrdmlsh_z_zzzi_h" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQRDMLSH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sqrdmlsh_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqrdmlsh_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQRDMLSH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sqrdmlsh_z_zzzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqrdmlsh_z_zzzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQRDMLSH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sqrdmulh_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqrdmulh_z_zz_" << std::endl; return; }
...
void test_sqrdmulh_z_zzi_h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqrdmulh_z_zzi_h" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQRDMULH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sqrdmulh_z_zzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqrdmulh_z_zzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQRDMULH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sqrdmulh_z_zzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqrdmulh_z_zzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQRDMULH);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_sqrshl_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqrshl_z_p_zz_" << std::endl; return; }
...
void test_sqrshlr_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqrshlr_z_p_zz_" << std::endl; return; }
...
void test_sqrshrn_z_mz2_b() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqrshrn_z_mz2_b" << std::endl; return; }
...
void test_sqrshrn_z_mz2_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqrshrn_z_mz2_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQRSHRN);
...
void test_sqrshrnb_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqrshrnb_z_zi_" << std::endl; return; }
...
void test_sqrshrnt_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqrshrnt_z_zi_" << std::endl; return; }
...
void test_sqrshrun_z_mz2_b() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqrshrun_z_mz2_b" << std::endl; return; }
...
void test_sqrshrun_z_mz2_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqrshrun_z_mz2_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQRSHRUN);
...
void test_sqrshrunb_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqrshrunb_z_zi_" << std::endl; return; }
...
void test_sqrshrunt_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqrshrunt_z_zi_" << std::endl; return; }
...
void test_sqshl_z_p_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqshl_z_p_zi_" << std::endl; return; }
...
void test_sqshl_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqshl_z_p_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQSHL);
...
void test_sqshlr_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqshlr_z_p_zz_" << std::endl; return; }
...
void test_sqshlu_z_p_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqshlu_z_p_zi_" << std::endl; return; }
...
void test_sqshrn_z_mz2_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqshrn_z_mz2_" << std::endl; return; }
...
void test_sqshrnb_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqshrnb_z_zi_" << std::endl; return; }
...
void test_sqshrnt_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqshrnt_z_zi_" << std::endl; return; }
...
void test_sqshrun_z_mz2_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqshrun_z_mz2_" << std::endl; return; }
...
void test_sqshrunb_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqshrunb_z_zi_" << std::endl; return; }
...
void test_sqshrunt_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqshrunt_z_zi_" << std::endl; return; }
...
void test_sqsub_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqsub_z_p_zz_" << std::endl; return; }
...
void test_sqsub_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqsub_z_zi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQSUB);
...
void test_sqsub_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqsub_z_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SQSUB);
...
void test_sqsubr_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqsubr_z_p_zz_" << std::endl; return; }
...
void test_sqxtnb_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqxtnb_z_zz_" << std::endl; return; }
...
void test_sqxtnt_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqxtnt_z_zz_" << std::endl; return; }
...
void test_sqxtunb_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqxtunb_z_zz_" << std::endl; return; }
...
void test_sqxtunt_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sqxtunt_z_zz_" << std::endl; return; }
...
void test_srhadd_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: srhadd_z_p_zz_" << std::endl; return; }
...
void test_sri_z_zzi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sri_z_zzi_" << std::endl; return; }
...
void test_srshl_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: srshl_z_p_zz_" << std::endl; return; }
...
void test_srshlr_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: srshlr_z_p_zz_" << std::endl; return; }
...
void test_srshr_z_p_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: srshr_z_p_zi_" << std::endl; return; }
...
void test_srsra_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: srsra_z_zi_" << std::endl; return; }
...
void test_sshllb_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sshllb_z_zi_" << std::endl; return; }
...
void test_sshllt_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sshllt_z_zi_" << std::endl; return; }
...
void test_ssra_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ssra_z_zi_" << std::endl; return; }
...
void test_ssublb_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ssublb_z_zz_" << std::endl; return; }
...
void test_ssublbt_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ssublbt_z_zz_" << std::endl; return; }
...
void test_ssublt_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ssublt_z_zz_" << std::endl; return; }
...
void test_ssubltb_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ssubltb_z_zz_" << std::endl; return; }
...
void test_ssubwb_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ssubwb_z_zz_" << std::endl; return; }
...
void test_ssubwt_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ssubwt_z_zz_" << std::endl; return; }
...
void test_st1b_z_p_ai_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1b_z_p_ai_s" << std::endl; return; }
...
void test_st1b_z_p_ai_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1b_z_p_ai_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1b_z_p_bi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1b_z_p_bi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1b_z_p_br_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1b_z_p_br_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1b_z_p_bz_d_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1b_z_p_bz_d_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1b_z_p_bz_s_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1b_z_p_bz_s_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1b_z_p_bz_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1b_z_p_bz_d_64_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1d_z_p_ai_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1d_z_p_ai_d" << std::endl; return; }
...
void test_st1d_z_p_bi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1d_z_p_bi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1d_z_p_bi_u128() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1d_z_p_bi_u128" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1d_z_p_br_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1d_z_p_br_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1d_z_p_br_u128() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1d_z_p_br_u128" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1d_z_p_bz_d_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1d_z_p_bz_d_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1d_z_p_bz_d_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1d_z_p_bz_d_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1d_z_p_bz_d_64_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1d_z_p_bz_d_64_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1d_z_p_bz_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1d_z_p_bz_d_64_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1h_z_p_ai_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1h_z_p_ai_s" << std::endl; return; }
...
void test_st1h_z_p_ai_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1h_z_p_ai_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1h_z_p_bi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1h_z_p_bi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1h_z_p_br_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1h_z_p_br_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1h_z_p_bz_s_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1h_z_p_bz_s_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1h_z_p_bz_d_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1h_z_p_bz_d_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1h_z_p_bz_d_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1h_z_p_bz_d_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1h_z_p_bz_s_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1h_z_p_bz_s_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1h_z_p_bz_d_64_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1h_z_p_bz_d_64_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1h_z_p_bz_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1h_z_p_bz_d_64_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1q_z_p_ar_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1q_z_p_ar_d_64_unscaled" << std::endl; return; }
...
void test_st1w_z_p_ai_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1w_z_p_ai_s" << std::endl; return; }
...
void test_st1w_z_p_ai_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1w_z_p_ai_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1w_z_p_bi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1w_z_p_bi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1w_z_p_bi_u128() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1w_z_p_bi_u128" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1w_z_p_br_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1w_z_p_br_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1w_z_p_br_u128() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1w_z_p_br_u128" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1w_z_p_bz_s_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1w_z_p_bz_s_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1w_z_p_bz_d_x32_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1w_z_p_bz_d_x32_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1w_z_p_bz_d_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1w_z_p_bz_d_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1w_z_p_bz_s_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1w_z_p_bz_s_x32_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1w_z_p_bz_d_64_scaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1w_z_p_bz_d_64_scaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st1w_z_p_bz_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st1w_z_p_bz_d_64_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st2b_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st2b_z_p_bi_contiguous" << std::endl; return; }
...
void test_st2b_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st2b_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST2B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st2d_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st2d_z_p_bi_contiguous" << std::endl; return; }
...
void test_st2d_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st2d_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST2D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st2h_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st2h_z_p_bi_contiguous" << std::endl; return; }
...
void test_st2h_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st2h_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST2H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st2q_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st2q_z_p_bi_contiguous" << std::endl; return; }
...
void test_st2q_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st2q_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST2Q);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st2w_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st2w_z_p_bi_contiguous" << std::endl; return; }
...
void test_st2w_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st2w_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST2W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st3b_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st3b_z_p_bi_contiguous" << std::endl; return; }
...
void test_st3b_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st3b_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST3B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st3d_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st3d_z_p_bi_contiguous" << std::endl; return; }
...
void test_st3d_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st3d_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST3D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st3h_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st3h_z_p_bi_contiguous" << std::endl; return; }
...
void test_st3h_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st3h_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST3H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st3q_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st3q_z_p_bi_contiguous" << std::endl; return; }
...
void test_st3q_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st3q_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST3Q);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st3w_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st3w_z_p_bi_contiguous" << std::endl; return; }
...
void test_st3w_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st3w_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST3W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st4b_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st4b_z_p_bi_contiguous" << std::endl; return; }
...
void test_st4b_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st4b_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST4B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st4d_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st4d_z_p_bi_contiguous" << std::endl; return; }
...
void test_st4d_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st4d_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST4D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st4h_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st4h_z_p_bi_contiguous" << std::endl; return; }
...
void test_st4h_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st4h_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST4H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st4q_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st4q_z_p_bi_contiguous" << std::endl; return; }
...
void test_st4q_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st4q_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST4Q);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_st4w_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st4w_z_p_bi_contiguous" << std::endl; return; }
...
void test_st4w_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: st4w_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ST4W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_stnt1b_z_p_ar_s_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: stnt1b_z_p_ar_s_x32_unscaled" << std::endl; return; }
...
void test_stnt1b_z_p_ar_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: stnt1b_z_p_ar_d_64_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::STNT1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_stnt1b_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: stnt1b_z_p_bi_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::STNT1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_stnt1b_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: stnt1b_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::STNT1B);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_stnt1d_z_p_ar_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: stnt1d_z_p_ar_d_64_unscaled" << std::endl; return; }
...
void test_stnt1d_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: stnt1d_z_p_bi_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::STNT1D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_stnt1d_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: stnt1d_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::STNT1D);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_stnt1h_z_p_ar_s_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: stnt1h_z_p_ar_s_x32_unscaled" << std::endl; return; }
...
void test_stnt1h_z_p_ar_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: stnt1h_z_p_ar_d_64_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::STNT1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_stnt1h_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: stnt1h_z_p_bi_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::STNT1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_stnt1h_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: stnt1h_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::STNT1H);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_stnt1w_z_p_ar_s_x32_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: stnt1w_z_p_ar_s_x32_unscaled" << std::endl; return; }
...
void test_stnt1w_z_p_ar_d_64_unscaled() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: stnt1w_z_p_ar_d_64_unscaled" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::STNT1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_stnt1w_z_p_bi_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: stnt1w_z_p_bi_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::STNT1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_stnt1w_z_p_br_contiguous() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: stnt1w_z_p_br_contiguous" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::STNT1W);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_str_p_bi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: str_p_bi_" << std::endl; return; }
...
void test_str_z_bi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: str_z_bi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::STR);
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Memory);
...
void test_sub_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sub_z_p_zz_" << std::endl; return; }
...
void test_sub_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sub_z_zi_" << std::endl; return; }
...
void test_sub_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sub_z_zz_" << std::endl; return; }
...
void test_subhnb_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: subhnb_z_zz_" << std::endl; return; }
...
void test_subhnt_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: subhnt_z_zz_" << std::endl; return; }
...
void test_subp_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: subp_z_p_zz_" << std::endl; return; }
...
void test_subpt_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: subpt_z_p_zz_" << std::endl; return; }
...
void test_subpt_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: subpt_z_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SUBPT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_subr_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: subr_z_p_zz_" << std::endl; return; }
...
void test_subr_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: subr_z_zi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SUBR);
...
void test_sudot_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sudot_z_zzzi_s" << std::endl; return; }
...
void test_sunpkhi_z_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sunpkhi_z_z_" << std::endl; return; }
...
void test_sunpklo_z_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sunpklo_z_z_" << std::endl; return; }
...
void test_suqadd_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: suqadd_z_p_zz_" << std::endl; return; }
...
void test_sxtb_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sxtb_z_p_z_m" << std::endl; return; }
...
void test_sxtb_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sxtb_z_p_z_z" << std::endl; return; }
...
void test_sxth_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sxth_z_p_z_m" << std::endl; return; }
...
void test_sxth_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sxth_z_p_z_z" << std::endl; return; }
...
void test_sxtw_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sxtw_z_p_z_m" << std::endl; return; }
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
    assert(result->operands[2].type == OperandType::Register);
...
void test_sxtw_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sxtw_z_p_z_z" << std::endl; return; }
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
    assert(result->operands[2].type == OperandType::Register);
...
void test_tbl_z_zz_1() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: tbl_z_zz_1" << std::endl; return; }
...
void test_tbl_z_zz_2() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: tbl_z_zz_2" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::TBL);
...
void test_tblq_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: tblq_z_zz_" << std::endl; return; }
...
void test_tbx_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: tbx_z_zz_" << std::endl; return; }
...
void test_tbxq_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: tbxq_z_zz_" << std::endl; return; }
...
void test_trn1_p_pp_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: trn1_p_pp_" << std::endl; return; }
...
void test_trn2_p_pp_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: trn2_p_pp_" << std::endl; return; }
...
void test_trn1_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: trn1_z_zz_" << std::endl; return; }
...
void test_trn1_z_zz_q() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: trn1_z_zz_q" << std::endl; return; }
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
    assert(result->operands[2].type == OperandType::Register);
...
void test_trn2_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: trn2_z_zz_" << std::endl; return; }
...
void test_trn2_z_zz_q() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: trn2_z_zz_q" << std::endl; return; }
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
    assert(result->operands[2].type == OperandType::Register);
...
void test_uaba_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uaba_z_zzz_" << std::endl; return; }
...
void test_uabal_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uabal_z_zz_" << std::endl; return; }
...
void test_uabalb_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uabalb_z_zzz_" << std::endl; return; }
...
void test_uabalt_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uabalt_z_zzz_" << std::endl; return; }
...
void test_uabd_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uabd_z_p_zz_" << std::endl; return; }
...
void test_uabdlb_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uabdlb_z_zz_" << std::endl; return; }
...
void test_uabdlt_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uabdlt_z_zz_" << std::endl; return; }
...
void test_uadalp_z_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uadalp_z_p_z_" << std::endl; return; }
...
void test_uaddlb_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uaddlb_z_zz_" << std::endl; return; }
...
void test_uaddlt_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uaddlt_z_zz_" << std::endl; return; }
...
void test_uaddv_r_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uaddv_r_p_z_" << std::endl; return; }
...
void test_uaddwb_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uaddwb_z_zz_" << std::endl; return; }
...
void test_uaddwt_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uaddwt_z_zz_" << std::endl; return; }
...
void test_uclamp_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uclamp_z_zz_" << std::endl; return; }
...
void test_ucvtf_z_p_z_h2fp16() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ucvtf_z_p_z_h2fp16" << std::endl; return; }
...
void test_ucvtf_z_p_z_h2fp16z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ucvtf_z_p_z_h2fp16z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UCVTF);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ucvtf_z_p_z_w2fp16() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ucvtf_z_p_z_w2fp16" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UCVTF);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ucvtf_z_p_z_w2fp16z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ucvtf_z_p_z_w2fp16z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UCVTF);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ucvtf_z_p_z_w2s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ucvtf_z_p_z_w2s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UCVTF);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ucvtf_z_p_z_w2sz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ucvtf_z_p_z_w2sz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UCVTF);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ucvtf_z_p_z_w2d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ucvtf_z_p_z_w2d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UCVTF);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ucvtf_z_p_z_w2dz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ucvtf_z_p_z_w2dz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UCVTF);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ucvtf_z_p_z_x2fp16() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ucvtf_z_p_z_x2fp16" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UCVTF);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ucvtf_z_p_z_x2fp16z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ucvtf_z_p_z_x2fp16z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UCVTF);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ucvtf_z_p_z_x2s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ucvtf_z_p_z_x2s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UCVTF);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ucvtf_z_p_z_x2sz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ucvtf_z_p_z_x2sz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UCVTF);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ucvtf_z_p_z_x2d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ucvtf_z_p_z_x2d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UCVTF);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ucvtf_z_p_z_x2dz() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ucvtf_z_p_z_x2dz" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UCVTF);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ucvtf_z_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ucvtf_z_z_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UCVTF);
...
void test_ucvtflt_z_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ucvtflt_z_z_" << std::endl; return; }
...
void test_udiv_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: udiv_z_p_zz_" << std::endl; return; }
...
void test_udivr_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: udivr_z_p_zz_" << std::endl; return; }
...
void test_udot_z16_zzz_h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: udot_z16_zzz_h" << std::endl; return; }
...
void test_udot_z32_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: udot_z32_zzz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UDOT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_udot_z16_zzzi_h() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: udot_z16_zzzi_h" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UDOT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_udot_z32_zzzi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: udot_z32_zzzi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UDOT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_udot_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: udot_z_zzz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UDOT);
...
void test_udot_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: udot_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UDOT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_udot_z_zzzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: udot_z_zzzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UDOT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_uhadd_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uhadd_z_p_zz_" << std::endl; return; }
...
void test_uhsub_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uhsub_z_p_zz_" << std::endl; return; }
...
void test_uhsubr_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uhsubr_z_p_zz_" << std::endl; return; }
...
void test_umax_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umax_z_p_zz_" << std::endl; return; }
...
void test_umax_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umax_z_zi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UMAX);
...
void test_umaxp_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umaxp_z_p_zz_" << std::endl; return; }
...
void test_umaxqv_z_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umaxqv_z_p_z_" << std::endl; return; }
...
void test_umaxv_r_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umaxv_r_p_z_" << std::endl; return; }
...
void test_umin_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umin_z_p_zz_" << std::endl; return; }
...
void test_umin_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umin_z_zi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UMIN);
...
void test_uminp_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uminp_z_p_zz_" << std::endl; return; }
...
void test_uminqv_z_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uminqv_z_p_z_" << std::endl; return; }
...
void test_uminv_r_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uminv_r_p_z_" << std::endl; return; }
...
void test_umlalb_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umlalb_z_zzz_" << std::endl; return; }
...
void test_umlalb_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umlalb_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UMLALB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_umlalb_z_zzzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umlalb_z_zzzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UMLALB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_umlalt_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umlalt_z_zzz_" << std::endl; return; }
...
void test_umlalt_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umlalt_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UMLALT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_umlalt_z_zzzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umlalt_z_zzzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UMLALT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_umlslb_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umlslb_z_zzz_" << std::endl; return; }
...
void test_umlslb_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umlslb_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UMLSLB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_umlslb_z_zzzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umlslb_z_zzzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UMLSLB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_umlslt_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umlslt_z_zzz_" << std::endl; return; }
...
void test_umlslt_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umlslt_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UMLSLT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_umlslt_z_zzzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umlslt_z_zzzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UMLSLT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ummla_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ummla_z_zzz_" << std::endl; return; }
...
void test_umulh_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umulh_z_p_zz_" << std::endl; return; }
...
void test_umulh_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umulh_z_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UMULH);
...
void test_umullb_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umullb_z_zz_" << std::endl; return; }
...
void test_umullb_z_zzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umullb_z_zzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UMULLB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_umullb_z_zzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umullb_z_zzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UMULLB);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_umullt_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umullt_z_zz_" << std::endl; return; }
...
void test_umullt_z_zzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umullt_z_zzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UMULLT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_umullt_z_zzi_d() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umullt_z_zzi_d" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UMULLT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_uqadd_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqadd_z_p_zz_" << std::endl; return; }
...
void test_uqadd_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqadd_z_zi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UQADD);
...
void test_uqadd_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqadd_z_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UQADD);
...
void test_uqcvtn_z_mz2_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqcvtn_z_mz2_" << std::endl; return; }
...
void test_uqdecb_r_rs_uw() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqdecb_r_rs_uw" << std::endl; return; }
...
void test_uqdecb_r_rs_x() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqdecb_r_rs_x" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UQDECB);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_uqdecd_r_rs_uw() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqdecd_r_rs_uw" << std::endl; return; }
...
void test_uqdecd_r_rs_x() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqdecd_r_rs_x" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UQDECD);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_uqdecd_z_zs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqdecd_z_zs_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UQDECD);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_uqdech_r_rs_uw() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqdech_r_rs_uw" << std::endl; return; }
...
void test_uqdech_r_rs_x() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqdech_r_rs_x" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UQDECH);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_uqdech_z_zs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqdech_z_zs_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UQDECH);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_uqdecp_r_p_r_uw() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqdecp_r_p_r_uw" << std::endl; return; }
...
void test_uqdecp_r_p_r_x() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqdecp_r_p_r_x" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UQDECP);
...
void test_uqdecp_z_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqdecp_z_p_z_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UQDECP);
...
void test_uqdecw_r_rs_uw() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqdecw_r_rs_uw" << std::endl; return; }
...
void test_uqdecw_r_rs_x() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqdecw_r_rs_x" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UQDECW);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_uqdecw_z_zs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqdecw_z_zs_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UQDECW);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_uqincb_r_rs_uw() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqincb_r_rs_uw" << std::endl; return; }
...
void test_uqincb_r_rs_x() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqincb_r_rs_x" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UQINCB);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_uqincd_r_rs_uw() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqincd_r_rs_uw" << std::endl; return; }
...
void test_uqincd_r_rs_x() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqincd_r_rs_x" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UQINCD);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_uqincd_z_zs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqincd_z_zs_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UQINCD);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_uqinch_r_rs_uw() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqinch_r_rs_uw" << std::endl; return; }
...
void test_uqinch_r_rs_x() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqinch_r_rs_x" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UQINCH);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_uqinch_z_zs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqinch_z_zs_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UQINCH);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_uqincp_r_p_r_uw() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqincp_r_p_r_uw" << std::endl; return; }
...
void test_uqincp_r_p_r_x() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqincp_r_p_r_x" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UQINCP);
...
void test_uqincp_z_p_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqincp_z_p_z_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UQINCP);
...
void test_uqincw_r_rs_uw() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqincw_r_rs_uw" << std::endl; return; }
...
void test_uqincw_r_rs_x() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqincw_r_rs_x" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UQINCW);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_uqincw_z_zs_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqincw_z_zs_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UQINCW);
    assert(result->operands.size() >= 1);
    assert(result->operands[0].type == OperandType::RegisterList);
...
void test_uqrshl_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqrshl_z_p_zz_" << std::endl; return; }
...
void test_uqrshlr_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqrshlr_z_p_zz_" << std::endl; return; }
...
void test_uqrshrn_z_mz2_b() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqrshrn_z_mz2_b" << std::endl; return; }
...
void test_uqrshrn_z_mz2_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqrshrn_z_mz2_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UQRSHRN);
...
void test_uqrshrnb_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqrshrnb_z_zi_" << std::endl; return; }
...
void test_uqrshrnt_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqrshrnt_z_zi_" << std::endl; return; }
...
void test_uqshl_z_p_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqshl_z_p_zi_" << std::endl; return; }
...
void test_uqshl_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqshl_z_p_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UQSHL);
...
void test_uqshlr_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqshlr_z_p_zz_" << std::endl; return; }
...
void test_uqshrn_z_mz2_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqshrn_z_mz2_" << std::endl; return; }
...
void test_uqshrnb_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqshrnb_z_zi_" << std::endl; return; }
...
void test_uqshrnt_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqshrnt_z_zi_" << std::endl; return; }
...
void test_uqsub_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqsub_z_p_zz_" << std::endl; return; }
...
void test_uqsub_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqsub_z_zi_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UQSUB);
...
void test_uqsub_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqsub_z_zz_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UQSUB);
...
void test_uqsubr_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqsubr_z_p_zz_" << std::endl; return; }
...
void test_uqxtnb_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqxtnb_z_zz_" << std::endl; return; }
...
void test_uqxtnt_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uqxtnt_z_zz_" << std::endl; return; }
...
void test_urecpe_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: urecpe_z_p_z_m" << std::endl; return; }
...
void test_urecpe_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: urecpe_z_p_z_z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::URECPE);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_urhadd_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: urhadd_z_p_zz_" << std::endl; return; }
...
void test_urshl_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: urshl_z_p_zz_" << std::endl; return; }
...
void test_urshlr_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: urshlr_z_p_zz_" << std::endl; return; }
...
void test_urshr_z_p_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: urshr_z_p_zi_" << std::endl; return; }
...
void test_ursqrte_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ursqrte_z_p_z_m" << std::endl; return; }
...
void test_ursqrte_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ursqrte_z_p_z_z" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::URSQRTE);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ursra_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ursra_z_zi_" << std::endl; return; }
...
void test_usdot_z_zzz_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: usdot_z_zzz_s" << std::endl; return; }
...
void test_usdot_z_zzzi_s() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: usdot_z_zzzi_s" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::USDOT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
...
void test_ushllb_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ushllb_z_zi_" << std::endl; return; }
...
void test_ushllt_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ushllt_z_zi_" << std::endl; return; }
...
void test_usmmla_z_zzz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: usmmla_z_zzz_" << std::endl; return; }
...
void test_usqadd_z_p_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: usqadd_z_p_zz_" << std::endl; return; }
...
void test_usra_z_zi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: usra_z_zi_" << std::endl; return; }
...
void test_usublb_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: usublb_z_zz_" << std::endl; return; }
...
void test_usublt_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: usublt_z_zz_" << std::endl; return; }
...
void test_usubwb_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: usubwb_z_zz_" << std::endl; return; }
...
void test_usubwt_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: usubwt_z_zz_" << std::endl; return; }
...
void test_uunpkhi_z_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uunpkhi_z_z_" << std::endl; return; }
...
void test_uunpklo_z_z_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uunpklo_z_z_" << std::endl; return; }
...
void test_uxtb_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uxtb_z_p_z_m" << std::endl; return; }
...
void test_uxtb_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uxtb_z_p_z_z" << std::endl; return; }
...
void test_uxth_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uxth_z_p_z_m" << std::endl; return; }
...
void test_uxth_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uxth_z_p_z_z" << std::endl; return; }
...
void test_uxtw_z_p_z_m() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uxtw_z_p_z_m" << std::endl; return; }
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
    assert(result->operands[2].type == OperandType::Register);
...
void test_uxtw_z_p_z_z() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uxtw_z_p_z_z" << std::endl; return; }
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
    assert(result->operands[2].type == OperandType::Register);
...
void test_uzp1_p_pp_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uzp1_p_pp_" << std::endl; return; }
...
void test_uzp2_p_pp_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uzp2_p_pp_" << std::endl; return; }
...
void test_uzp1_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uzp1_z_zz_" << std::endl; return; }
...
void test_uzp1_z_zz_q() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uzp1_z_zz_q" << std::endl; return; }
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
    assert(result->operands[2].type == OperandType::Register);
...
void test_uzp2_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uzp2_z_zz_" << std::endl; return; }
...
void test_uzp2_z_zz_q() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uzp2_z_zz_q" << std::endl; return; }
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
    assert(result->operands[2].type == OperandType::Register);
...
void test_uzpq1_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uzpq1_z_zz_" << std::endl; return; }
...
void test_uzpq2_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uzpq2_z_zz_" << std::endl; return; }
...
void test_whilege_p_p_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: whilege_p_p_rr_" << std::endl; return; }
...
void test_whilege_pn_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: whilege_pn_rr_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::WHILEGE);
...
void test_whilege_pp_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: whilege_pp_rr_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::WHILEGE);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_whilegt_p_p_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: whilegt_p_p_rr_" << std::endl; return; }
...
void test_whilegt_pn_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: whilegt_pn_rr_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::WHILEGT);
...
void test_whilegt_pp_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: whilegt_pp_rr_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::WHILEGT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_whilehi_p_p_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: whilehi_p_p_rr_" << std::endl; return; }
...
void test_whilehi_pn_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: whilehi_pn_rr_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::WHILEHI);
...
void test_whilehi_pp_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: whilehi_pp_rr_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::WHILEHI);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_whilehs_p_p_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: whilehs_p_p_rr_" << std::endl; return; }
...
void test_whilehs_pn_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: whilehs_pn_rr_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::WHILEHS);
...
void test_whilehs_pp_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: whilehs_pp_rr_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::WHILEHS);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_whilele_p_p_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: whilele_p_p_rr_" << std::endl; return; }
...
void test_whilele_pn_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: whilele_pn_rr_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::WHILELE);
...
void test_whilele_pp_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: whilele_pp_rr_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::WHILELE);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_whilelo_p_p_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: whilelo_p_p_rr_" << std::endl; return; }
...
void test_whilelo_pn_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: whilelo_pn_rr_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::WHILELO);
...
void test_whilelo_pp_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: whilelo_pp_rr_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::WHILELO);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_whilels_p_p_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: whilels_p_p_rr_" << std::endl; return; }
...
void test_whilels_pn_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: whilels_pn_rr_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::WHILELS);
...
void test_whilels_pp_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: whilels_pp_rr_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::WHILELS);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_whilelt_p_p_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: whilelt_p_p_rr_" << std::endl; return; }
...
void test_whilelt_pn_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: whilelt_pn_rr_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::WHILELT);
...
void test_whilelt_pp_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: whilelt_pp_rr_" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::WHILELT);
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::RegisterList);
    assert(result->operands[1].type == OperandType::Register);
...
void test_whilerw_p_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: whilerw_p_rr_" << std::endl; return; }
...
void test_whilewr_p_rr_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: whilewr_p_rr_" << std::endl; return; }
...
void test_wrffr_f_p_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: wrffr_f_p_" << std::endl; return; }
...
void test_xar_z_zzi_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: xar_z_zzi_" << std::endl; return; }
...
void test_zip2_p_pp_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: zip2_p_pp_" << std::endl; return; }
...
void test_zip1_p_pp_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: zip1_p_pp_" << std::endl; return; }
...
void test_zip2_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: zip2_z_zz_" << std::endl; return; }
...
void test_zip2_z_zz_q() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: zip2_z_zz_q" << std::endl; return; }
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
    assert(result->operands[2].type == OperandType::Register);
...
void test_zip1_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: zip1_z_zz_" << std::endl; return; }
...
void test_zip1_z_zz_q() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: zip1_z_zz_q" << std::endl; return; }
    assert(result->operands.size() >= 3);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::Register);
    assert(result->operands[2].type == OperandType::Register);
...
void test_zipq1_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: zipq1_z_zz_" << std::endl; return; }
...
void test_zipq2_z_zz_() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: zipq2_z_zz_" << std::endl; return; }
