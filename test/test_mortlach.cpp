...
void test_addha_za_pp_z_32() {
    ...
    uint32_t test_insn = 0xC0900000u;
...
void test_addspl_r_ri_() {
    ...
    uint32_t test_insn = 0x04605800u;
...
void test_addsvl_r_ri_() {
    ...
    uint32_t test_insn = 0x04205800u;
...
void test_addva_za_pp_z_32() {
    ...
    uint32_t test_insn = 0xC0910000u;
...
void test_bfmopa_za32_pp_zz_() {
    ...
    uint32_t test_insn = 0x81800000u;
...
void test_bfmops_za32_pp_zz_() {
    ...
    uint32_t test_insn = 0x81800010u;
...
void test_fmopa_za32_pp_zz_16() {
    ...
    uint32_t test_insn = 0x81A00000u;
...
void test_fmops_za32_pp_zz_16() {
    ...
    uint32_t test_insn = 0x81A00010u;
...
void test_ld1b_za_p_rrr_() {
    ...
    uint32_t test_insn = 0xE0000000u;
...
void test_ld1d_za_p_rrr_() {
    ...
    uint32_t test_insn = 0xE0C00000u;
