...
void test_add_32_addsub_imm() {
    ...
    if (!result.has_value()) { std::cerr << "DECODE FAIL: add_32_addsub_imm" << std::endl; return; }
...
void test_add_64_addsub_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: add_64_addsub_imm" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ADD);
...
void test_addg_64_addsub_immtags() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: addg_64_addsub_immtags" << std::endl; return; }
...
void test_adds_32s_addsub_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: adds_32s_addsub_imm" << std::endl; return; }
...
void test_adds_64s_addsub_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: adds_64s_addsub_imm" << std::endl; return; }
...
void test_adr_only_pcreladdr() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: adr_only_pcreladdr" << std::endl; return; }
...
void test_adrp_only_pcreladdr() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: adrp_only_pcreladdr" << std::endl; return; }
...
void test_and_32_log_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: and_32_log_imm" << std::endl; return; }
...
void test_and_64_log_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: and_64_log_imm" << std::endl; return; }
...
void test_ands_32s_log_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ands_32s_log_imm" << std::endl; return; }
...
void test_ands_64s_log_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ands_64s_log_imm" << std::endl; return; }
...
void test_asr_sbfm_32m_bitfield() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: asr_sbfm_32m_bitfield" << std::endl; return; }
...
void test_asr_sbfm_64m_bitfield() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: asr_sbfm_64m_bitfield" << std::endl; return; }
...
void test_autiasppc_only_dp_1src_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: autiasppc_only_dp_1src_imm" << std::endl; return; }
...
void test_autibsppc_only_dp_1src_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: autibsppc_only_dp_1src_imm" << std::endl; return; }
...
void test_bfc_bfm_32m_bitfield() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfc_bfm_32m_bitfield" << std::endl; return; }
...
void test_bfc_bfm_64m_bitfield() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfc_bfm_64m_bitfield" << std::endl; return; }
...
void test_bfi_bfm_32m_bitfield() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfi_bfm_32m_bitfield" << std::endl; return; }
...
void test_bfi_bfm_64m_bitfield() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfi_bfm_64m_bitfield" << std::endl; return; }
...
void test_bfm_32m_bitfield() {
    uint32_t insn = 0x33000000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfm_32m_bitfield" << std::endl; return; }
...
void test_bfm_64m_bitfield() {
    uint32_t insn = 0xB3400000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfm_64m_bitfield" << std::endl; return; }
...
void test_bfxil_bfm_32m_bitfield() {
    uint32_t insn = 0x33000000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfxil_bfm_32m_bitfield" << std::endl; return; }
...
void test_bfxil_bfm_64m_bitfield() {
    uint32_t insn = 0xB3400000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: bfxil_bfm_64m_bitfield" << std::endl; return; }
...
void test_cmn_adds_32s_addsub_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmn_adds_32s_addsub_imm" << std::endl; return; }
...
void test_cmn_adds_64s_addsub_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmn_adds_64s_addsub_imm" << std::endl; return; }
...
void test_cmp_subs_32s_addsub_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmp_subs_32s_addsub_imm" << std::endl; return; }
...
void test_cmp_subs_64s_addsub_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: cmp_subs_64s_addsub_imm" << std::endl; return; }
...
void test_eor_32_log_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: eor_32_log_imm" << std::endl; return; }
...
void test_eor_64_log_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: eor_64_log_imm" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::EOR);
...
void test_extr_32_extract() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: extr_32_extract" << std::endl; return; }
...
void test_extr_64_extract() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: extr_64_extract" << std::endl; return; }
...
void test_lsl_ubfm_32m_bitfield() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: lsl_ubfm_32m_bitfield" << std::endl; return; }
...
void test_lsl_ubfm_64m_bitfield() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: lsl_ubfm_64m_bitfield" << std::endl; return; }
...
void test_lsr_ubfm_32m_bitfield() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: lsr_ubfm_32m_bitfield" << std::endl; return; }
...
void test_lsr_ubfm_64m_bitfield() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: lsr_ubfm_64m_bitfield" << std::endl; return; }
...
void test_mov_add_32_addsub_imm() {
    uint32_t insn = 0x11000000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mov_add_32_addsub_imm" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ADD);
...
void test_mov_add_64_addsub_imm() {
    uint32_t insn = 0x91000000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mov_add_64_addsub_imm" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::ADD);
...
void test_mov_movn_32_movewide() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mov_movn_32_movewide" << std::endl; return; }
...
void test_mov_movn_64_movewide() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mov_movn_64_movewide" << std::endl; return; }
...
void test_mov_movz_32_movewide() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mov_movz_32_movewide" << std::endl; return; }
...
void test_mov_movz_64_movewide() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mov_movz_64_movewide" << std::endl; return; }
...
void test_mov_orr_32_log_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mov_orr_32_log_imm" << std::endl; return; }
...
void test_mov_orr_64_log_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: mov_orr_64_log_imm" << std::endl; return; }
...
void test_movk_32_movewide() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: movk_32_movewide" << std::endl; return; }
...
void test_movk_64_movewide() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: movk_64_movewide" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::MOVK);
    assert(result->operands.size() >= 2);
    assert(result->operands[0].type == OperandType::Register);
    assert(result->operands[1].type == OperandType::RegisterList);
...
void test_movn_32_movewide() {
    uint32_t insn = 0x12800000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: movn_32_movewide" << std::endl; return; }
...
void test_movn_64_movewide() {
    uint32_t insn = 0x92800000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: movn_64_movewide" << std::endl; return; }
...
void test_movz_32_movewide() {
    uint32_t insn = 0x52800000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: movz_32_movewide" << std::endl; return; }
...
void test_movz_64_movewide() {
    uint32_t insn = 0xD2800000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: movz_64_movewide" << std::endl; return; }
...
void test_orr_32_log_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: orr_32_log_imm" << std::endl; return; }
...
void test_orr_64_log_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: orr_64_log_imm" << std::endl; return; }
...
void test_ror_extr_32_extract() {
    uint32_t insn = 0x13800000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ror_extr_32_extract" << std::endl; return; }
...
void test_ror_extr_64_extract() {
    uint32_t insn = 0x93C00000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ror_extr_64_extract" << std::endl; return; }
...
void test_sbfiz_sbfm_32m_bitfield() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sbfiz_sbfm_32m_bitfield" << std::endl; return; }
...
void test_sbfiz_sbfm_64m_bitfield() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sbfiz_sbfm_64m_bitfield" << std::endl; return; }
...
void test_sbfm_32m_bitfield() {
    uint32_t insn = 0x13000000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sbfm_32m_bitfield" << std::endl; return; }
...
void test_sbfm_64m_bitfield() {
    uint32_t insn = 0x93400000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sbfm_64m_bitfield" << std::endl; return; }
...
void test_sbfx_sbfm_32m_bitfield() {
    uint32_t insn = 0x13000000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sbfx_sbfm_32m_bitfield" << std::endl; return; }
...
void test_sbfx_sbfm_64m_bitfield() {
    uint32_t insn = 0x93400000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sbfx_sbfm_64m_bitfield" << std::endl; return; }
...
void test_smax_32_minmax_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smax_32_minmax_imm" << std::endl; return; }
...
void test_smax_64_minmax_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smax_64_minmax_imm" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SMAX);
...
void test_smin_32_minmax_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smin_32_minmax_imm" << std::endl; return; }
...
void test_smin_64_minmax_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: smin_64_minmax_imm" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::SMIN);
...
void test_sub_32_addsub_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sub_32_addsub_imm" << std::endl; return; }
...
void test_sub_64_addsub_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sub_64_addsub_imm" << std::endl; return; }
...
void test_subg_64_addsub_immtags() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: subg_64_addsub_immtags" << std::endl; return; }
...
void test_subs_32s_addsub_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: subs_32s_addsub_imm" << std::endl; return; }
...
void test_subs_64s_addsub_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: subs_64s_addsub_imm" << std::endl; return; }
...
void test_sxtb_sbfm_32m_bitfield() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sxtb_sbfm_32m_bitfield" << std::endl; return; }
...
void test_sxtb_sbfm_64m_bitfield() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sxtb_sbfm_64m_bitfield" << std::endl; return; }
...
void test_sxth_sbfm_32m_bitfield() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sxth_sbfm_32m_bitfield" << std::endl; return; }
...
void test_sxth_sbfm_64m_bitfield() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sxth_sbfm_64m_bitfield" << std::endl; return; }
...
void test_sxtw_sbfm_64m_bitfield() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: sxtw_sbfm_64m_bitfield" << std::endl; return; }
...
void test_tst_ands_32s_log_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: tst_ands_32s_log_imm" << std::endl; return; }
...
void test_tst_ands_64s_log_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: tst_ands_64s_log_imm" << std::endl; return; }
...
void test_ubfiz_ubfm_32m_bitfield() {
    uint32_t insn = 0x53000000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ubfiz_ubfm_32m_bitfield" << std::endl; return; }
...
void test_ubfiz_ubfm_64m_bitfield() {
    uint32_t insn = 0xD3400000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ubfiz_ubfm_64m_bitfield" << std::endl; return; }
...
void test_ubfm_32m_bitfield() {
    uint32_t insn = 0x53000000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ubfm_32m_bitfield" << std::endl; return; }
...
void test_ubfm_64m_bitfield() {
    uint32_t insn = 0xD3400000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ubfm_64m_bitfield" << std::endl; return; }
...
void test_ubfx_ubfm_32m_bitfield() {
    uint32_t insn = 0x53000000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ubfx_ubfm_32m_bitfield" << std::endl; return; }
...
void test_ubfx_ubfm_64m_bitfield() {
    uint32_t insn = 0xD3400000u;
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: ubfx_ubfm_64m_bitfield" << std::endl; return; }
...
void test_umax_32u_minmax_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umax_32u_minmax_imm" << std::endl; return; }
...
void test_umax_64u_minmax_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umax_64u_minmax_imm" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UMAX);
...
void test_umin_32u_minmax_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umin_32u_minmax_imm" << std::endl; return; }
...
void test_umin_64u_minmax_imm() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: umin_64u_minmax_imm" << std::endl; return; }
    assert(result->mnemonic == Mnemonic::UMIN);
...
void test_uxtb_ubfm_32m_bitfield() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uxtb_ubfm_32m_bitfield" << std::endl; return; }
...
void test_uxth_ubfm_32m_bitfield() {
    ...
    auto result = decode(insn);
    if (!result.has_value()) { std::cerr << "DECODE FAIL: uxth_ubfm_32m_bitfield" << std::endl; return; }
