...
std::optional<Instruction> decode_dpimm(uint32_t insn, bool aliases) {
    (void)aliases;
    ...
    switch (insn & 0xFFFFFC00u) {
        case 0x11000000u: { // MOV_ADD_32_addsub_imm
            ...
            #else
                        Instruction result(aliases ? Mnemonic::MOV : Mnemonic::ADD, insn);
            #endif
                        DpimmEncoding enc = {};
                        enc.raw = insn;
        ...
        case 0x13001C00u: { // SXTB_SBFM_32M_bitfield
            ...
            #else
                        Instruction result(aliases ? Mnemonic::SXTB : Mnemonic::SBFM, insn);
            #endif
                        DpimmEncoding enc = {};
                        enc.raw = insn;
        ...
        case 0x13003C00u: { // SXTH_SBFM_32M_bitfield
            ...
            #else
                        Instruction result(aliases ? Mnemonic::SXTH : Mnemonic::SBFM, insn);
            #endif
                        DpimmEncoding enc = {};
                        enc.raw = insn;
        ...
        case 0x53001C00u: { // UXTB_UBFM_32M_bitfield
            ...
            #else
                        Instruction result(aliases ? Mnemonic::UXTB : Mnemonic::UBFM, insn);
            #endif
                        DpimmEncoding enc = {};
                        enc.raw = insn;
        ...
        case 0x53003C00u: { // UXTH_UBFM_32M_bitfield
            ...
            #else
                        Instruction result(aliases ? Mnemonic::UXTH : Mnemonic::UBFM, insn);
            #endif
                        DpimmEncoding enc = {};
                        enc.raw = insn;
        ...
        case 0x93407C00u: { // SXTW_SBFM_64M_bitfield
            ...
            #else
                        Instruction result(aliases ? Mnemonic::SXTW : Mnemonic::SBFM, insn);
            #endif
                        DpimmEncoding enc = {};
                        enc.raw = insn;
    ...
    switch (insn & 0xFFC0FC00u) {
        case 0x13007C00u: { // ASR_SBFM_32M_bitfield
            ...
            #else
                        Instruction result(aliases ? Mnemonic::ASR : Mnemonic::SBFM, insn);
            #endif
                        DpimmEncoding enc = {};
                        enc.raw = insn;
                        bool is_64bit = false;
        ...
        case 0x53007C00u: { // LSR_UBFM_32M_bitfield
            ...
            #else
                        Instruction result(aliases ? Mnemonic::LSR : Mnemonic::UBFM, insn);
            #endif
                        DpimmEncoding enc = {};
                        enc.raw = insn;
                        bool is_64bit = false;
    ...
    switch (insn & 0xFFC003E0u) {
        case 0x320003E0u: { // MOV_ORR_32_log_imm
            ...
            if (aliases && result.operands.size() >= 3) result.operands.erase(result.operands.begin() + 1);
                        return result;
        }
        case 0x330003E0u: { // BFC_BFM_32M_bitfield
            ...
            #else
                        Instruction result(aliases ? Mnemonic::BFC : Mnemonic::BFM, insn);
            #endif
                        DpimmEncoding enc = {};
                        enc.raw = insn;
                        bool is_64bit = false;
    ...
    switch (insn & 0xFFC00000u) {
        ...
        case 0x12800000u: { // MOV_MOVN_32_movewide
            ...
            #ifdef VEDA64_IR
                        Instruction result(aliases ? Mnemonic::MOV : Mnemonic::MOVN, insn, EncodingId::MOV_MOVN_32_movewide);
            #else
                        Instruction result(aliases ? Mnemonic::MOV : Mnemonic::MOVN, insn);
            #endif
                        DpimmEncoding enc = {};
                        enc.raw = insn;
        ...
        case 0x13000000u: { // SBFIZ_SBFM_32M_bitfield
            ...
            #ifdef VEDA64_IR
                        Instruction result(aliases ? Mnemonic::SBFIZ : Mnemonic::SBFM, insn, EncodingId::SBFIZ_SBFM_32M_bitfield);
            #else
                        Instruction result(aliases ? Mnemonic::SBFIZ : Mnemonic::SBFM, insn);
            #endif
                        DpimmEncoding enc = {};
                        enc.raw = insn;
                        bool is_64bit = false;
        ...
        case 0x33000000u: { // BFI_BFM_32M_bitfield
            ...
            if (!(((insn >> 5) & 0x1F) == 0x1F)) {
                #ifdef VEDA64_IR
                                Instruction result(aliases ? Mnemonic::BFI : Mnemonic::BFM, insn, EncodingId::BFI_BFM_32M_bitfield);
                #else
                                Instruction result(aliases ? Mnemonic::BFI : Mnemonic::BFM, insn);
                #endif
                                DpimmEncoding enc = {};
                                enc.raw = insn;
                                bool is_64bit = false;
        ...
        case 0x52800000u: { // MOV_MOVZ_32_movewide
            ...
            #ifdef VEDA64_IR
                        Instruction result(aliases ? Mnemonic::MOV : Mnemonic::MOVZ, insn, EncodingId::MOV_MOVZ_32_movewide);
            #else
                        Instruction result(aliases ? Mnemonic::MOV : Mnemonic::MOVZ, insn);
            #endif
                        DpimmEncoding enc = {};
                        enc.raw = insn;
        ...
        case 0x53000000u: { // LSL_UBFM_32M_bitfield
            ...
            #ifdef VEDA64_IR
                        Instruction result(aliases ? Mnemonic::LSL : Mnemonic::UBFM, insn, EncodingId::LSL_UBFM_32M_bitfield);
            #else
                        Instruction result(aliases ? Mnemonic::LSL : Mnemonic::UBFM, insn);
            #endif
                        DpimmEncoding enc = {};
                        enc.raw = insn;
                        bool is_64bit = false;
            ...
            if (aliases && result.operands.size() >= 4) {
                result.operands[2] = Operand::imm((32 - static_cast<uint32_t>(result.operands[2].iv.value)) & 31);
        ...
        case 0x93400000u: { // SBFIZ_SBFM_64M_bitfield
            ...
            #ifdef VEDA64_IR
                        Instruction result(aliases ? Mnemonic::SBFIZ : Mnemonic::SBFM, insn, EncodingId::SBFIZ_SBFM_64M_bitfield);
            #else
                        Instruction result(aliases ? Mnemonic::SBFIZ : Mnemonic::SBFM, insn);
            #endif
                        DpimmEncoding enc = {};
        ...
        case 0xB3400000u: { // BFI_BFM_64M_bitfield
            ...
            if (!(((insn >> 5) & 0x1F) == 0x1F)) {
                #ifdef VEDA64_IR
                                Instruction result(aliases ? Mnemonic::BFI : Mnemonic::BFM, insn, EncodingId::BFI_BFM_64M_bitfield);
                #else
                                Instruction result(aliases ? Mnemonic::BFI : Mnemonic::BFM, insn);
                #endif
                                DpimmEncoding enc = {};
        ...
        case 0xD3400000u: { // LSL_UBFM_64M_bitfield
            ...
            #ifdef VEDA64_IR
                        Instruction result(aliases ? Mnemonic::LSL : Mnemonic::UBFM, insn, EncodingId::LSL_UBFM_64M_bitfield);
            #else
                        Instruction result(aliases ? Mnemonic::LSL : Mnemonic::UBFM, insn);
            #endif
                        DpimmEncoding enc = {};
            ...
            if (aliases && result.operands.size() >= 4) {
                result.operands[2] = Operand::imm((64 - static_cast<uint32_t>(result.operands[2].iv.value)) & 63);
                result.operands.pop_back();
            }
                        return result;
        }
    ...
    switch (insn & 0xFF800000u) {
        ...
        case 0x92800000u: { // MOV_MOVN_64_movewide
            ...
            #ifdef VEDA64_IR
                        Instruction result(aliases ? Mnemonic::MOV : Mnemonic::MOVN, insn, EncodingId::MOV_MOVN_64_movewide);
            #else
                        Instruction result(aliases ? Mnemonic::MOV : Mnemonic::MOVN, insn);
            #endif
                        DpimmEncoding enc = {};
        ...
        case 0xD2800000u: { // MOV_MOVZ_64_movewide
            ...
            #ifdef VEDA64_IR
                        Instruction result(aliases ? Mnemonic::MOV : Mnemonic::MOVZ, insn, EncodingId::MOV_MOVZ_64_movewide);
            #else
                        Instruction result(aliases ? Mnemonic::MOV : Mnemonic::MOVZ, insn);
            #endif
                        DpimmEncoding enc = {};
