...
Tree build_ir_ADD_32_addsub_shift(uint32_t insn) {
    ...
    // Decode pseudocode
    {
        auto& stmts = tree.decode_stmts;
        {
            ...
            {
                std::vector<ir::StmtPtr> bb_2;
                br_1.push_back({ ir::bin_op("==", ir::ident("shift"), ir::bit_lit("11")), std::move(bb_2) });
            }
            stmts.push_back(ir::if_stmt(std::move(br_1)));
        }
        {
            ...
            {
                std::vector<ir::StmtPtr> bb_4;
                br_3.push_back({ ir::bin_op("&&", ir::bin_op("==", ir::ident("sf"), ir::bit_lit("0")), ir::bin_op("==", ir::bit_slice(ir::ident("imm6"), ir::int_lit(5), ir::int_lit(5), false), ir::bit_lit("1"))), std::move(bb_4) });
            }
            stmts.push_back(ir::if_stmt(std::move(br_3)));
        }
        stmts.push_back(ir::let_decl("d", "integer", ir::func_call("UInt", {}, {ir::ident("Rd")})));
...
Tree build_ir_ADDPT_64_addsub_pt(uint32_t insn) {
    ...
    // Decode pseudocode
    {
        auto& stmts = tree.decode_stmts;
        {
            ...
            {
                std::vector<ir::StmtPtr> bb_2;
                br_1.push_back({ ir::unary_op("!", ir::func_call("IsFeatureImplemented", {}, {ir::ident("FEAT_CPA")})), std::move(bb_2) });
            }
            stmts.push_back(ir::if_stmt(std::move(br_1)));
        }
        stmts.push_back(ir::let_decl("d", "integer", ir::func_call("UInt", {}, {ir::ident("Rd")})));
...
Tree build_ir_AND_32_log_shift(uint32_t insn) {
    ...
    // Decode pseudocode
    {
        auto& stmts = tree.decode_stmts;
        {
            ...
            {
                std::vector<ir::StmtPtr> bb_2;
                br_1.push_back({ ir::bin_op("&&", ir::bin_op("==", ir::ident("sf"), ir::bit_lit("0")), ir::bin_op("==", ir::bit_slice(ir::ident("imm6"), ir::int_lit(5), ir::int_lit(5), false), ir::bit_lit("1"))), std::move(bb_2) });
            }
            stmts.push_back(ir::if_stmt(std::move(br_1)));
        }
        stmts.push_back(ir::let_decl("d", "integer", ir::func_call("UInt", {}, {ir::ident("Rd")})));
...
Tree build_ir_AUTDA_64P_dp_1src(uint32_t insn) {
    ...
    // Decode pseudocode
    {
        ...
        }
        {
            ...
            {
                std::vector<ir::StmtPtr> bb_4;
                br_3.push_back({ ir::bin_op("&&", ir::bin_op("==", ir::ident("Z"), ir::bit_lit("1")), ir::bin_op("!=", ir::ident("Rn"), ir::bit_lit("11111"))), std::move(bb_4) });
            }
            stmts.push_back(ir::if_stmt(std::move(br_3)));
        }
            ...
            std::vector<std::pair<ir::ExprPtr, std::vector<ir::StmtPtr>>> br_5;
            {
                std::vector<ir::StmtPtr> bb_6;
                {
                    std::vector<std::pair<ir::ExprPtr, std::vector<ir::StmtPtr>>> br_7;
                    {
                        ...
                        br_7.push_back({ ir::bin_op("&&", ir::func_call("IsFeatureImplemented", {}, {ir::ident("FEAT_PAuth_LR")}), ir::bin_op("==", ir::field_access(ir::ident("PSTATE"), "PACM"), ir::bit_lit("1"))), std::move(bb_8) });
                    }
                    {
            ...
            }
            {
                std::vector<ir::StmtPtr> bb_10;
                {
                    std::vector<std::pair<ir::ExprPtr, std::vector<ir::StmtPtr>>> br_11;
                    {
                        ...
                        br_11.push_back({ ir::bin_op("&&", ir::bin_op("&&", ir::func_call("IsFeatureImplemented", {}, {ir::ident("FEAT_PAuth_LR")}), ir::bin_op("==", ir::field_access(ir::ident("PSTATE"), "PACM"), ir::bit_lit("1"))), ir::ident("autia1716")), std::move(bb_12) });
                    }
                    {
            ...
            }
            {
                std::vector<ir::StmtPtr> bb_10;
                {
                    std::vector<std::pair<ir::ExprPtr, std::vector<ir::StmtPtr>>> br_11;
                    {
                        ...
                        br_11.push_back({ ir::bin_op("&&", ir::bin_op("&&", ir::func_call("IsFeatureImplemented", {}, {ir::ident("FEAT_PAuth_LR")}), ir::bin_op("==", ir::field_access(ir::ident("PSTATE"), "PACM"), ir::bit_lit("1"))), ir::ident("autib1716")), std::move(bb_12) });
                    }
                    {
                        std::vector<ir::StmtPtr> bb_13;
    ...
    // Execute pseudocode
    {
        auto& stmts = tree.execute_stmts;
        {
            std::vector<std::pair<ir::ExprPtr, std::vector<ir::StmtPtr>>> br_1;
            {
                ...
                bb_2.push_back(ir::let_decl("operand1", "bits(datasize)", ir::func_call("X", {}, {ir::ident("n")})));
                bb_2.push_back(ir::let_decl("operand2", "bits(datasize)", ir::ident("imm")));
                bb_2.push_back(ir::tuple_assign({"-", "flags"}, ir::func_call("AddWithCarry", {ir::ident("datasize")}, {ir::ident("operand1"), ir::unary_op("NOT", ir::ident("operand2")), ir::bit_lit("1")})));
                br_1.push_back({ ir::func_call("ConditionHolds", {}, {ir::ident("condition")}), std::move(bb_2) });
            }
            stmts.push_back(ir::if_stmt(std::move(br_1)));
        }
...
Tree build_ir_CRC32B_32C_dp_2src(uint32_t insn) {
    ...
    // Decode pseudocode
    {
        auto& stmts = tree.decode_stmts;
        {
            ...
            {
                std::vector<ir::StmtPtr> bb_2;
                br_1.push_back({ ir::unary_op("!", ir::func_call("IsFeatureImplemented", {}, {ir::ident("FEAT_CRC32")})), std::move(bb_2) });
            }
            stmts.push_back(ir::if_stmt(std::move(br_1)));
        }
        stmts.push_back(ir::let_decl("d", "integer", ir::func_call("UInt", {}, {ir::ident("Rd")})));
        ...
        stmts.push_back(ir::let_decl("m", "integer", ir::func_call("UInt", {}, {ir::ident("Rm")})));
        {
            ...
            {
                std::vector<ir::StmtPtr> bb_4;
                br_3.push_back({ ir::bin_op("&&", ir::bin_op("==", ir::ident("sf"), ir::bit_lit("1")), ir::bin_op("!=", ir::ident("sz"), ir::bit_lit("11"))), std::move(bb_4) });
            }
            stmts.push_back(ir::if_stmt(std::move(br_3)));
        }
        {
            ...
            {
                std::vector<ir::StmtPtr> bb_6;
                br_5.push_back({ ir::bin_op("&&", ir::bin_op("==", ir::ident("sf"), ir::bit_lit("0")), ir::bin_op("==", ir::ident("sz"), ir::bit_lit("11"))), std::move(bb_6) });
            }
            stmts.push_back(ir::if_stmt(std::move(br_5)));
        }
...
Tree build_ir_CSINC_32_condsel(uint32_t insn) {
    ...
    // Execute pseudocode
    {
        ...
        stmts.push_back(ir::var_decl("result", "bits(datasize)", nullptr));
        {
            ...
            {
                std::vector<ir::StmtPtr> bb_3;
                bb_3.push_back(ir::assign(ir::ident("result"), ir::bin_op("+", ir::func_call("X", {ir::ident("datasize")}, {ir::ident("m")}), ir::int_lit(1))));
                br_1.push_back({ nullptr, std::move(bb_3) });
            }
            stmts.push_back(ir::if_stmt(std::move(br_1)));
        }
...
Tree build_ir_CSINV_32_condsel(uint32_t insn) {
    ...
    // Execute pseudocode
    {
        ...
        stmts.push_back(ir::var_decl("result", "bits(datasize)", nullptr));
        {
            ...
            {
                std::vector<ir::StmtPtr> bb_3;
                bb_3.push_back(ir::assign(ir::ident("result"), ir::unary_op("NOT", ir::func_call("X", {ir::ident("datasize")}, {ir::ident("m")}))));
                br_1.push_back({ nullptr, std::move(bb_3) });
            }
            stmts.push_back(ir::if_stmt(std::move(br_1)));
        }
...
Tree build_ir_CSNEG_32_condsel(uint32_t insn) {
    ...
    // Execute pseudocode
    {
        ...
        stmts.push_back(ir::var_decl("result", "bits(datasize)", nullptr));
        {
            ...
            {
                std::vector<ir::StmtPtr> bb_3;
                bb_3.push_back(ir::assign(ir::ident("result"), ir::bin_op("+", ir::unary_op("NOT", ir::func_call("X", {ir::ident("datasize")}, {ir::ident("m")})), ir::int_lit(1))));
                br_1.push_back({ nullptr, std::move(bb_3) });
            }
            stmts.push_back(ir::if_stmt(std::move(br_1)));
        }
            ...
            std::vector<std::pair<ir::ExprPtr, std::vector<ir::StmtPtr>>> br_3;
            {
                std::vector<ir::StmtPtr> bb_4;
                {
                    std::vector<std::pair<ir::ExprPtr, std::vector<ir::StmtPtr>>> br_5;
                    {
                        ...
                        br_5.push_back({ ir::bin_op("==", ir::ident("n"), ir::int_lit(31)), std::move(bb_6) });
                    }
                    bb_4.push_back(ir::if_stmt(std::move(br_5)));
                }
                br_3.push_back({ ir::bin_op("==", ir::ident("Z"), ir::bit_lit("0")), std::move(bb_4) });
            }
            {
                std::vector<ir::StmtPtr> bb_7;
                {
                    ...
                    {
                        std::vector<ir::StmtPtr> bb_9;
                        br_8.push_back({ ir::bin_op("!=", ir::ident("n"), ir::int_lit(31)), std::move(bb_9) });
                    }
    ...
    // Decode pseudocode
    {
        ...
        stmts.push_back(ir::let_decl("m", "integer", ir::func_call("UInt", {}, {ir::ident("Rm")})));
        {
            std::vector<std::pair<ir::ExprPtr, std::vector<ir::StmtPtr>>> br_3;
            {
                ...
                br_3.push_back({ ir::bin_op("==", ir::ident("m"), ir::int_lit(31)), std::move(bb_4) });
            }
            stmts.push_back(ir::if_stmt(std::move(br_3)));
        }
    }
            ...
            std::vector<std::pair<ir::ExprPtr, std::vector<ir::StmtPtr>>> br_10;
            {
                std::vector<ir::StmtPtr> bb_11;
                {
                    std::vector<std::pair<ir::ExprPtr, std::vector<ir::StmtPtr>>> br_12;
                    {
                        ...
                        br_12.push_back({ ir::bin_op("&&", ir::func_call("IsFeatureImplemented", {}, {ir::ident("FEAT_PAuth_LR")}), ir::bin_op("==", ir::field_access(ir::ident("PSTATE"), "PACM"), ir::bit_lit("1"))), std::move(bb_13) });
                    }
                    {
            ...
            }
            {
                std::vector<ir::StmtPtr> bb_15;
                {
                    std::vector<std::pair<ir::ExprPtr, std::vector<ir::StmtPtr>>> br_16;
                    {
                        ...
                        br_16.push_back({ ir::bin_op("&&", ir::bin_op("&&", ir::func_call("IsFeatureImplemented", {}, {ir::ident("FEAT_PAuth_LR")}), ir::bin_op("==", ir::field_access(ir::ident("PSTATE"), "PACM"), ir::bit_lit("1"))), ir::ident("pacia1716")), std::move(bb_17) });
                    }
                    {
            ...
            }
            {
                std::vector<ir::StmtPtr> bb_15;
                {
                    std::vector<std::pair<ir::ExprPtr, std::vector<ir::StmtPtr>>> br_16;
                    {
                        ...
                        br_16.push_back({ ir::bin_op("&&", ir::bin_op("&&", ir::func_call("IsFeatureImplemented", {}, {ir::ident("FEAT_PAuth_LR")}), ir::bin_op("==", ir::field_access(ir::ident("PSTATE"), "PACM"), ir::bit_lit("1"))), ir::ident("pacib1716")), std::move(bb_17) });
                    }
                    {
                        std::vector<ir::StmtPtr> bb_18;
...
Tree build_ir_RBIT_32_dp_1src(uint32_t insn) {
    ...
    // Execute pseudocode
    {
        ...
        stmts.push_back(ir::var_decl("result", "bits(datasize)", nullptr));
        {
            ...
            fb_1.push_back(ir::assign(ir::bit_slice(ir::ident("result"), ir::bin_op("-", ir::bin_op("-", ir::ident("datasize"), ir::int_lit(1)), ir::ident("i")), ir::bin_op("-", ir::bin_op("-", ir::ident("datasize"), ir::int_lit(1)), ir::ident("i")), false), ir::bit_slice(ir::ident("operand"), ir::ident("i"), ir::ident("i"), false)));
            stmts.push_back(ir::for_stmt("i", ir::int_lit(0), ir::bin_op("-", ir::ident("datasize"), ir::int_lit(1)), "to", std::move(fb_1)));
        }
        stmts.push_back(ir::assign(ir::func_call("X", {ir::ident("datasize")}, {ir::ident("d")}), ir::ident("result")));
    }
...
Tree build_ir_REV_32_dp_1src(uint32_t insn) {
    ...
    // Decode pseudocode
    {
        auto& stmts = tree.decode_stmts;
        {
            ...
            {
                std::vector<ir::StmtPtr> bb_2;
                br_1.push_back({ ir::bin_op("&&", ir::bin_op("==", ir::ident("opc"), ir::bit_lit("11")), ir::bin_op("==", ir::ident("sf"), ir::bit_lit("0"))), std::move(bb_2) });
            }
            stmts.push_back(ir::if_stmt(std::move(br_1)));
        }
        stmts.push_back(ir::let_decl("d", "integer", ir::func_call("UInt", {}, {ir::ident("Rd")})));
    ...
    // Execute pseudocode
    {
        ...
        stmts.push_back(ir::let_decl("containers", "integer", ir::bin_op("DIV", ir::ident("datasize"), ir::ident("container_size"))));
        {
            ...
            fb_3.push_back(ir::let_decl("container", "bits(container_size)", ir::bit_slice(ir::ident("operand"), ir::ident("container_size"), ir::bin_op("*", ir::ident("c"), ir::ident("container_size")), true)));
            fb_3.push_back(ir::assign(ir::bit_slice(ir::ident("result"), ir::ident("container_size"), ir::bin_op("*", ir::ident("c"), ir::ident("container_size")), true), ir::func_call("Reverse", {ir::ident("container_size")}, {ir::ident("container"), ir::int_lit(8)})));
            stmts.push_back(ir::for_stmt("c", ir::int_lit(0), ir::bin_op("-", ir::ident("containers"), ir::int_lit(1)), "to", std::move(fb_3)));
        }
        stmts.push_back(ir::assign(ir::func_call("X", {ir::ident("datasize")}, {ir::ident("d")}), ir::ident("result")));
    }
    ...
    // Execute pseudocode
    {
        ...
        stmts.push_back(ir::let_decl("flags", "bits(4)", ir::bit_slice(ir::bit_concat({ir::ident("reg"), ir::ident("reg")}), ir::bin_op("+", ir::ident("imm"), ir::int_lit(3)), ir::ident("imm"), false)));
        {
            std::vector<std::pair<ir::ExprPtr, std::vector<ir::StmtPtr>>> br_3;
            {
                ...
                br_3.push_back({ ir::bin_op("==", ir::bit_slice(ir::ident("flagmask"), ir::int_lit(3), ir::int_lit(3), false), ir::bit_lit("1")), std::move(bb_4) });
            }
            stmts.push_back(ir::if_stmt(std::move(br_3)));
        }
        {
            std::vector<std::pair<ir::ExprPtr, std::vector<ir::StmtPtr>>> br_5;
            {
                ...
                br_5.push_back({ ir::bin_op("==", ir::bit_slice(ir::ident("flagmask"), ir::int_lit(2), ir::int_lit(2), false), ir::bit_lit("1")), std::move(bb_6) });
            }
            stmts.push_back(ir::if_stmt(std::move(br_5)));
        }
        {
            std::vector<std::pair<ir::ExprPtr, std::vector<ir::StmtPtr>>> br_7;
            {
                ...
                br_7.push_back({ ir::bin_op("==", ir::bit_slice(ir::ident("flagmask"), ir::int_lit(1), ir::int_lit(1), false), ir::bit_lit("1")), std::move(bb_8) });
            }
        ...
        }
        {
            std::vector<std::pair<ir::ExprPtr, std::vector<ir::StmtPtr>>> br_9;
            {
                ...
                br_9.push_back({ ir::bin_op("==", ir::bit_slice(ir::ident("flagmask"), ir::int_lit(0), ir::int_lit(0), false), ir::bit_lit("1")), std::move(bb_10) });
            }
    ...
    // Execute pseudocode
    {
        ...
        stmts.push_back(ir::var_decl("result", "integer", nullptr));
        {
            std::vector<std::pair<ir::ExprPtr, std::vector<ir::StmtPtr>>> br_1;
            {
                ...
                br_1.push_back({ ir::bin_op("==", ir::ident("divisor"), ir::int_lit(0)), std::move(bb_2) });
            }
            {
                std::vector<ir::StmtPtr> bb_3;
                bb_3.push_back(ir::assign(ir::ident("result"), ir::bin_op("DIVRM", ir::func_call("Abs", {}, {ir::ident("dividend")}), ir::func_call("Abs", {}, {ir::ident("divisor")}))));
                br_1.push_back({ ir::bin_op("==", ir::bin_op("<", ir::ident("dividend"), ir::int_lit(0)), ir::bin_op("<", ir::ident("divisor"), ir::int_lit(0))), std::move(bb_3) });
            }
            {
                std::vector<ir::StmtPtr> bb_4;
                bb_4.push_back(ir::assign(ir::ident("result"), ir::unary_op("-", ir::bin_op("DIVRM", ir::func_call("Abs", {}, {ir::ident("dividend")}), ir::func_call("Abs", {}, {ir::ident("divisor")})))));
...
Tree build_ir_UDIV_32_dp_2src(uint32_t insn) {
    ...
    // Execute pseudocode
    {
        ...
        stmts.push_back(ir::var_decl("result", "integer", nullptr));
        {
            ...
            {
                std::vector<ir::StmtPtr> bb_3;
                bb_3.push_back(ir::assign(ir::ident("result"), ir::bin_op("DIVRM", ir::ident("dividend"), ir::ident("divisor"))));
                br_1.push_back({ nullptr, std::move(bb_3) });
            }
            stmts.push_back(ir::if_stmt(std::move(br_1)));
        }
